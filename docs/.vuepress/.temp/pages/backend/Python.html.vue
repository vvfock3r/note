<template><div><h2 id="一、python解释器" tabindex="-1"><a class="header-anchor" href="#一、python解释器" aria-hidden="true">#</a> 一、Python解释器</h2>
<p>官方文档：<a href="https://docs.python.org/zh-cn/3.9/tutorial/interpreter.html" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.9/tutorial/interpreter.html<ExternalLinkIcon/></a></p>
<h3 id="解释器的多种实现" tabindex="-1"><a class="header-anchor" href="#解释器的多种实现" aria-hidden="true">#</a> 解释器的多种实现</h3>
<p>官方文档：<a href="https://docs.python.org/zh-cn/3.9/reference/introduction.html#implementations" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.9/reference/introduction.html#implementations<ExternalLinkIcon/></a></p>
<p>CPython</p>
<p>这是最早出现并持续维护的 Python 实现，以 C 语言编写。新的语言特性通常在此率先添加。</p>
<p>平常使用的就是CPython</p>
<p>Jython</p>
<p>以 Java 语言编写的 Python 实现。此实现可以作为 Java 应用的一个脚本语言，或者可以用来创建需要 Java 类库支持的应用。想了解更多信息可访问 <a href="http://www.jython.org/" target="_blank" rel="noopener noreferrer">Jython 网站<ExternalLinkIcon/></a></p>
<p>Python for .NET</p>
<p>此实现实际上使用了 CPython 实现，但是属于 .NET 托管应用并且可以引入 .NET 类库。它的创造者是 Brian Lloyd。想了解详情可访问 <a href="https://pythonnet.github.io/" target="_blank" rel="noopener noreferrer">Python for .NET 主页<ExternalLinkIcon/></a></p>
<p>IronPython</p>
<p>另一个 .NET 的 Python 实现，与 Python.NET 不同点在于它是生成 IL 的完全 Python 实现，并且将 Python 代码直接编译为 .NET 程序集。它的创造者就是当初创造 Jython 的 Jim Hugunin。想了解详情可访问 <a href="http://ironpython.net/" target="_blank" rel="noopener noreferrer">IronPython 网站<ExternalLinkIcon/></a></p>
<p>PyPy</p>
<p>完全使用 Python 语言编写的 Python 实现。它支持多个其他实现所没有的高级特性，例如非栈式支持和 JIT 编译器等。此项目的目标之一是通过允许方便地修改解释器 (因为它是用 Python 编写的)，鼓励该对语言本身进行试验。想了解详情可访问 <a href="http://pypy.org/" target="_blank" rel="noopener noreferrer">PyPy 项目主页<ExternalLinkIcon/></a></p>
<p>总结</p>
<table>
<thead>
<tr>
...
<td>C</td>
<td>CPython</td>
<td><a href="https://www.python.org/" target="_blank" rel="noopener noreferrer">https://www.python.org/<ExternalLinkIcon/></a></td>
<td>官方实现</td>
</tr>
<tr>
<td>Python</td>
<td>PyPy</td>
<td><a href="https://www.pypy.org/" target="_blank" rel="noopener noreferrer">https://www.pypy.org/<ExternalLinkIcon/></a></td>
<td>Python实现</td>
</tr>
<tr>
<td>Java</td>
<td>Jython</td>
<td><a href="https://www.jython.org/" target="_blank" rel="noopener noreferrer">https://www.jython.org/<ExternalLinkIcon/></a></td>
<td>Java实现</td>
</tr>
<tr>
<td>.Net</td>
<td>Python for .NET和IronPython</td>
<td><a href="https://pythonnet.github.io/" target="_blank" rel="noopener noreferrer">https://pythonnet.github.io/<ExternalLinkIcon/></a><br /><a href="https://ironpython.net/" target="_blank" rel="noopener noreferrer">https://ironpython.net/<ExternalLinkIcon/></a></td>
<td>.Net相关，但是并非完全由.Net实现</td>
</tr>
</tbody>
</table>
<h3 id="增强版交互式解释器-repl" tabindex="-1"><a class="header-anchor" href="#增强版交互式解释器-repl" aria-hidden="true">#</a> 增强版交互式解释器（REPL）</h3>
<h4 id="ipython" tabindex="-1"><a class="header-anchor" href="#ipython" aria-hidden="true">#</a> IPython</h4>
<p>官网地址：<a href="https://ipython.org/" target="_blank" rel="noopener noreferrer">https://ipython.org/<ExternalLinkIcon/></a></p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token comment"># 安装</span>
pip <span class="token function">install</span> ipython

<span class="token comment"># 启动</span>
ipython
</code></pre></div><h4 id="jupyter-notebook" tabindex="-1"><a class="header-anchor" href="#jupyter-notebook" aria-hidden="true">#</a> Jupyter Notebook</h4>
<p>官网地址：<a href="https://jupyter.org/" target="_blank" rel="noopener noreferrer">https://jupyter.org/<ExternalLinkIcon/></a></p>
<p>安装</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token comment"># 安装 </span>
...
<tr>
<td>Ctrl + Enter</td>
<td>执行语句，并保持在当前Cell（行）</td>
</tr>
<tr>
<td>Shift + Enter</td>
<td>执行语句，并进入下一个Cell（行）</td>
</tr>
<tr>
<td>↑↓</td>
<td>上/下一个Cell（行）</td>
...
<p>主要用来再不改动代码的情况下，方便不同Python版本之间的切换</p>
<p>####　Pyenv</p>
<p>Pyenv（非Windows版本）项目地址：<a href="https://github.com/pyenv/pyenv" target="_blank" rel="noopener noreferrer">https://github.com/pyenv/pyenv<ExternalLinkIcon/></a></p>
<p>Pyenv-Win(Windows版本) 项目地址：<a href="https://github.com/pyenv-win/pyenv-win" target="_blank" rel="noopener noreferrer">https://github.com/pyenv-win/pyenv-win<ExternalLinkIcon/></a></p>
<p>Pyenv安装</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token comment"># windows cmd命令行安装</span>
...
</code></pre></div><p>Pyenv命令</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token comment"># 查看所有可安装版本</span>
...
</code></pre></div><h3 id="全局解释器锁gil" tabindex="-1"><a class="header-anchor" href="#全局解释器锁gil" aria-hidden="true">#</a> 全局解释器锁GIL</h3>
<h4 id="gil是什么" tabindex="-1"><a class="header-anchor" href="#gil是什么" aria-hidden="true">#</a> GIL是什么？</h4>
<p>GIL，全称为Global Interpreter Lock，中文翻译为全局解释器锁，属于互斥锁，</p>
<p>简单来说就是给Python解释器上了一把锁，同一时刻只允许同时一个线程执行代码，同一时刻只能利用单核CPU，</p>
<p>这就导致Python的多线程并非是真正的多线程</p>
<h4 id="gil的优点" tabindex="-1"><a class="header-anchor" href="#gil的优点" aria-hidden="true">#</a> GIL的优点</h4>
<p>CPython使用引用计数作为垃圾回收器的内存管理技术，工作原理如下：</p>
<p>1.每个对象都有一个引用计数，</p>
<p>2.当对象被赋给一个新的变量名或被添加到一个容器(如元组、列表等)时，引用计数会增加，</p>
<p>​    同样，当引用超出范围或调用del语句时，引用计数也会减少</p>
<p>3.当一个对象的引用计数达到0时，它将被垃圾回收，分配的内存将被释放</p>
<p>在多线程下引用计数变量需要被保护（因为赋值等操作是非原子的），此时有两种解决办法：</p>
<p>（1）给每个对象添加一个锁，这可能 增加死锁的可能性，并且性能开销较大</p>
<p>（2）添加全局解释器锁，只有一把锁，管理简单，且开销较小</p>
<h4 id="gil的缺点" tabindex="-1"><a class="header-anchor" href="#gil的缺点" aria-hidden="true">#</a> GIL的缺点</h4>
<p>GIL导致Python无法真正的使用多核CPU资源，无法真正并行</p>
<p>总结</p>
<p>CPU密集型任务不适合多线程，相比单线程反而会降低效率，此时可以使用多进程代替</p>
<p>IO密集型任务可以使用多线程</p>
<p>参考资料</p>
<p>官方Wiki：<a href="https://wiki.python.org/moin/GlobalInterpreterLock" target="_blank" rel="noopener noreferrer">https://wiki.python.org/moin/GlobalInterpreterLock<ExternalLinkIcon/></a></p>
<h3 id="常用选项及环境变量" tabindex="-1"><a class="header-anchor" href="#常用选项及环境变量" aria-hidden="true">#</a> 常用选项及环境变量</h3>
<p>官方文档：<a href="https://docs.python.org/zh-cn/3.9/using/cmdline.html#using-on-general" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.9/using/cmdline.html#using-on-general<ExternalLinkIcon/></a></p>
<h4 id="c-command-执行python代码" tabindex="-1"><a class="header-anchor" href="#c-command-执行python代码" aria-hidden="true">#</a> -c	&lt;command&gt;	执行Python代码</h4>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code>python -c <span class="token string">"import sys;print('.'.join([str(x) for x in sys.version_info[:3]]))"</span>
<span class="token number">3.9</span>.2
</code></pre></div><h4 id="m-module-name-执行模块代码" tabindex="-1"><a class="header-anchor" href="#m-module-name-执行模块代码" aria-hidden="true">#</a> -m &lt;module-name&gt;	执行模块代码</h4>
<p>执行模块中<code v-pre>if __name__ == '__main__':</code>下面的内容</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token comment"># 示例1 - 开启http server</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h4 id="b-在导入模块时不生成-pyc文件" tabindex="-1"><a class="header-anchor" href="#b-在导入模块时不生成-pyc文件" aria-hidden="true">#</a> -B  在导入模块时不生成.pyc文件</h4>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment"># pyc_test.py</span>
...
</code></pre></div><h4 id="u-禁用缓冲区" tabindex="-1"><a class="header-anchor" href="#u-禁用缓冲区" aria-hidden="true">#</a> -u 禁用缓冲区</h4>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment"># test.py</span>
...
</code></pre></div><h4 id="w-args-警告控制" tabindex="-1"><a class="header-anchor" href="#w-args-警告控制" aria-hidden="true">#</a> -w args 警告控制</h4>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token comment"># warn_test.py</span>
...
更细致的控制请参考官方文档
</code></pre></div><h4 id="x-跳过第一行内容" tabindex="-1"><a class="header-anchor" href="#x-跳过第一行内容" aria-hidden="true">#</a> -x 跳过第一行内容</h4>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment"># test.py</span>
fdafdref3fdfdfdafd
...
</code></pre></div><h4 id="e-忽略所有-python-环境变量" tabindex="-1"><a class="header-anchor" href="#e-忽略所有-python-环境变量" aria-hidden="true">#</a> -E 忽略所有 <code v-pre>PYTHON*</code> 环境变量</h4>
<h4 id="q-在交互模式下也不显示版权和版本信息" tabindex="-1"><a class="header-anchor" href="#q-在交互模式下也不显示版权和版本信息" aria-hidden="true">#</a> -q 在交互模式下也不显示版权和版本信息</h4>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code>C:<span class="token punctuation">\</span>Users<span class="token punctuation">\</span>VVFock3r<span class="token operator">></span>python -q
...
<h2 id="二、变量和数据结构" tabindex="-1"><a class="header-anchor" href="#二、变量和数据结构" aria-hidden="true">#</a> 二、变量和数据结构</h2>
<h3 id="查看变量" tabindex="-1"><a class="header-anchor" href="#查看变量" aria-hidden="true">#</a> 查看变量</h3>
<table>
<thead>
<tr>
<th>内置函数</th>
...
<tr>
<td>locals()</td>
<td>返回当前作用域内变量组成的字典，如果当前在全局则返回全局变量组成的字典</td>
</tr>
<tr>
<td>vars(obj)</td>
<td>返回obj对象作用域内变量组成的字典，<br />（1）如果不传参数，vars和locals作用一样<br />（2）如果传1个参数，等同于<code v-pre>obj.__dict__</code></td>
</tr>
</tbody>
</table>
<p>代码示例</p>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token number">2022</span>-04-05 <span class="token number">10</span>:53:24,984	 <span class="token punctuation">[</span>MainThread, <span class="token number">291696</span><span class="token punctuation">]</span> 测试1: 在全局使用3个函数, 效果是一样的
...
<span class="token number">2022</span>-04-05 <span class="token number">10</span>:53:24,984	 <span class="token punctuation">[</span>MainThread, <span class="token number">291696</span><span class="token punctuation">]</span> True
</code></pre></div><h3 id="列表-list" tabindex="-1"><a class="header-anchor" href="#列表-list" aria-hidden="true">#</a> 列表(list)</h3>
<p>文档：<a href="https://docs.python.org/zh-cn/3/library/stdtypes.html#list" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3/library/stdtypes.html#list<ExternalLinkIcon/></a></p>
<p><strong>列表推导式</strong></p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code>x <span class="token operator">=</span> <span class="token punctuation">[</span>x <span class="token keyword">for</span> x <span class="token keyword">in</span> <span class="token builtin">range</span><span class="token punctuation">(</span><span class="token number">100</span><span class="token punctuation">)</span><span class="token punctuation">]</span>
...
</code></pre></div><p><strong>列表方法</strong></p>
<table>
<thead>
<tr>
<th>分类</th>
...
<tr>
<td>插入元素</td>
<td><strong><code v-pre>append(self, object, /)</code></strong></td>
<td>在尾部插入一个元素，时间复杂度 O(1)</td>
</tr>
<tr>
<td></td>
<td><code v-pre>insert(self, index, object, /)</code></td>
<td>在指定索引处插入一个元素，时间复杂度 O(n)</td>
</tr>
<tr>
<td></td>
<td><code v-pre>extend(self, list)</code></td>
<td>列表合并（会改变原列表内容）</td>
</tr>
<tr>
<td>删除元素</td>
<td><strong><code v-pre>pop(self, index=-1, /)</code></strong></td>
<td>默认从索引为-1的位置弹出该值（弹出后列表删除该元素），<br />尾部弹出时间复杂度为 O(1)，其他位置弹出时间复杂度为 O(n)；<br />如果元素不存在，则引发 <code v-pre>IndexError</code></td>
</tr>
<tr>
<td></td>
<td><code v-pre>remove(self, value, /)</code></td>
<td>删除第一个值为value的元素，时间复杂度 O(n) ；<br />如果元素不存在，则引发 ValueError</td>
</tr>
<tr>
<td></td>
<td><code v-pre>clear(self, /)</code></td>
<td>清空列表所有元素， 时间复杂度 O(1)</td>
</tr>
<tr>
<td>列表反转</td>
<td><code v-pre>reverse(self, /)</code></td>
<td>列表反转（会改变原列表内容）</td>
</tr>
<tr>
<td></td>
<td><code v-pre>reversed(list)</code></td>
<td>列表反转，返回一个迭代器（不会改变原列表内容）</td>
</tr>
<tr>
<td>列表排序</td>
<td><code v-pre>sort(self, /, *, key=None, reverse=False)</code></td>
<td>根据key指定的函数进行排序，返回值为None（会改变原列表内容）</td>
</tr>
<tr>
<td></td>
<td><code v-pre>sorted(iterable, /, *, key=None, reverse=False)</code></td>
<td>根据key指定的函数进行排序，返回一个迭代器（不会改变原列表内容）</td>
</tr>
<tr>
<td>列表复制</td>
<td><code v-pre>copy(self, /)</code></td>
<td>返回一个新列表，浅拷贝（shadow copy），<br />根据被拷贝对象不同而操作不同：<br />（1）如果是不可变类型，则分配一块新内存地址；<br />（2）如果是可变类型，则直接引用</td>
</tr>
<tr>
<td></td>
<td><code v-pre>[::]</code></td>
<td>同<code v-pre>copy()</code></td>
</tr>
<tr>
<td></td>
<td><code v-pre>copy.deepcopy(x, memo=None, _nil=[])</code></td>
<td>返回一个新列表，深拷贝(deep copy)</td>
</tr>
<tr>
<td>列表查找</td>
<td><code v-pre>index(self, value, start=0, stop=9223372036854775807, /)</code></td>
<td>返回value在列表中的索引号，找不到抛出ValueError异常</td>
</tr>
<tr>
<td></td>
<td><code v-pre>count(self, value, /)</code></td>
<td>返回value在列表中出现的次数</td>
</tr>
</tbody>
</table>
<p><strong>列表常见操作效率对比</strong></p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8 -*-</span>
...
</code></pre></div><h3 id="元组-tuple" tabindex="-1"><a class="header-anchor" href="#元组-tuple" aria-hidden="true">#</a> 元组(tuple)</h3>
<p>文档：<a href="https://docs.python.org/zh-cn/3/library/stdtypes.html#tuple" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3/library/stdtypes.html#tuple<ExternalLinkIcon/></a></p>
<p><strong>元祖方法</strong></p>
<table>
<thead>
<tr>
<th>分类</th>
...
<tr>
<td>查找</td>
<td><code v-pre>index(value, start=0, stop=9223372036854775807, /)</code></td>
<td>返回value在元组中第一次出现的索引号，找不到抛出ValueError异常</td>
</tr>
<tr>
<td></td>
<td><code v-pre>count(value, /)</code></td>
<td>返回value在元组中出现的次数</td>
</tr>
</tbody>
</table>
<p><strong>高级数据结构：命名元组</strong></p>
<p>命名元组函数签名</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code>namedtuple<span class="token punctuation">(</span>typename<span class="token punctuation">,</span> field_names<span class="token punctuation">,</span> <span class="token operator">*</span><span class="token punctuation">,</span> rename<span class="token operator">=</span><span class="token boolean">False</span><span class="token punctuation">,</span> defaults<span class="token operator">=</span><span class="token boolean">None</span><span class="token punctuation">,</span> module<span class="token operator">=</span><span class="token boolean">None</span><span class="token punctuation">)</span>
</code></pre></div><p>命名元组示例</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8 -*-</span>
...
<h3 id="字符串-str" tabindex="-1"><a class="header-anchor" href="#字符串-str" aria-hidden="true">#</a> 字符串(str)</h3>
<p>文档：<a href="https://docs.python.org/3/library/stdtypes.html#str" target="_blank" rel="noopener noreferrer">https://docs.python.org/3/library/stdtypes.html#str<ExternalLinkIcon/></a></p>
<p><strong>（1）字符串类签名</strong></p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token keyword">class</span> <span class="token class-name">str</span><span class="token punctuation">(</span><span class="token builtin">object</span><span class="token operator">=</span><span class="token string">b''</span><span class="token punctuation">,</span> encoding<span class="token operator">=</span><span class="token string">'utf-8'</span><span class="token punctuation">,</span> errors<span class="token operator">=</span><span class="token string">'strict'</span><span class="token punctuation">)</span>
</code></pre></div><p>根据传入的对象创建一个新字符串</p>
<ul>
<li>
<p>如果<code v-pre>encoding</code>和<code v-pre>errors</code>都没有指定值，那么会调用<code v-pre>object.__str__()</code>，如果对象没有<code v-pre>__str__()</code>方法，那么会调用<code v-pre>repr(object)</code></p>
</li>
<li>
<p>如果encoding和errors至少指定一个值，那么该输入对象应该是一个 bytes-like对象，</p>
<p>此时就相当于<code v-pre>str(bytes, encoding, errors)</code> == <code v-pre>bytes.decode(encoding, errors)</code></p>
</li>
<li>
<p>encoding默认值从<code v-pre>sys.getdefaultencoding()</code>中获取</p>
</li>
</ul>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8 -*-</span>
...
<span class="token comment"># Hello python, hello world</span>
</code></pre></div><p>③ 使用f-string（推荐）</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code>name1 <span class="token operator">=</span> <span class="token string">"python"</span>
...
</code></pre></div><p><strong>（3）格式化输修饰符</strong></p>
<table>
<thead>
<tr>
<th>修饰符</th>
...
<td>用空白补充该变量的长度到n(在两边补充)</td>
</tr>
<tr>
<td><code v-pre>{:#^n}</code></td>
<td>用#号补充该变量的长度到n(在两边补充)，并设置为剧中对齐；格式为：<code v-pre>补充-对齐-宽度-小数点保留位数</code></td>
</tr>
</tbody>
</table>
<p>格式化修饰符演示</p>
...
<p>输出结果</p>
<p><img src="https://tuchuang-1257805459.cos.ap-shanghai.myqcloud.com/image-20220405164801876.png" alt="image-20220405164801876"></p>
<p><strong>（4）字符串常用方法</strong></p>
<table>
<thead>
<tr>
<th>分类</th>
...
<td>大小写转换</td>
<td>str.casefold()</td>
<td>返回一个新字符串，把所有大写字母改为小写（除了英文，对于其他语言同样有效）</td>
</tr>
<tr>
<td></td>
<td>str.lower()</td>
<td>返回一个新字符串，把所有大写字母改为小写（针对A-Z）</td>
</tr>
<tr>
<td></td>
<td>str.upper()</td>
<td>返回一个新字符串，把所有小写字母改为大写（针对A-Z）</td>
</tr>
<tr>
<td></td>
<td>str.swapcase()</td>
<td>翻转字符串，大写变小写，小写变大写</td>
</tr>
<tr>
<td>搜索</td>
<td>str.count(<em>sub</em>[, <em>start</em>[, <em>end</em>]])</td>
<td>返回sub在字符串出现的次数，start和end表示起始范围（可选）</td>
</tr>
<tr>
<td></td>
<td>str.find(<em>sub</em>[, <em>start</em>[, <em>end</em>]])</td>
<td>检查字符串sub是否包含在字符串中，如果有则返回索引值，没有则返回-1<br />只有当你明确确定位置或需要得到索引值时，才应该使用find方法，否则应该使用in<br />类似的还有<code v-pre>str.rfind</code>，从右向左开始查找</td>
</tr>
<tr>
<td></td>
<td>str.index(<em>sub</em>[, <em>start</em>[, <em>end</em>]])</td>
<td>与find类型，当sub找不到的时候会引发<code v-pre>ValueError异常</code><br />类似的还有rindex，从右向左开始查找</td>
</tr>
<tr>
<td>分割和合并</td>
<td>str.split(<em>sep=None</em>, <em>maxsplit=-1</em>)</td>
<td>以\n,\r和\r\n和空白为分隔符分割字符串，返回一个列表，sep指定分隔符，maxsplit指定分割次数<br />类似的有str.rsplit，从右向左开始分割</td>
</tr>
<tr>
<td></td>
<td>str.splitlines([<em>keepends</em>])</td>
<td>以\n,\r和\r\n为分隔符，返回一个列表;如果keepends为True,则分隔符保留，否则丢弃</td>
</tr>
<tr>
<td></td>
<td>str.join(<em>iterable</em>)</td>
<td>字符串连接<br />join里的参数的所有元素必须是字符串类型，否则会报错,解决方法可以这样：<br /><code v-pre>'-'.join([str(x) for x in range(10)])</code></td>
</tr>
<tr>
<td>替换</td>
<td>str.replace(<em>old</em>, <em>new</em>[, <em>count</em>])</td>
<td>将字符串中的old替换为new，count指定替换次数，可选，默认全部替换</td>
</tr>
<tr>
<td>删除左右空白</td>
<td>str.strip([<em>chars</em>])</td>
<td>删除字符串两侧的字符，默认为空白，<br />类似的还有lstrip（只删除左边的字符）、rstrip（只删除右边的字符）</td>
</tr>
<tr>
<td>开头、结尾匹配</td>
<td>str.startswith(<em>prefix</em>[, <em>start</em>[, <em>end</em>]])</td>
<td>检查字符串是否以prefix子字符串开头，start和end表示匹配的起始范围（可选）</td>
</tr>
<tr>
<td></td>
<td>str.endswith(<em>suffix</em>[, <em>start</em>[, <em>end</em>]])</td>
<td>同上</td>
</tr>
<tr>
<td>制表符</td>
<td>str.expandtabs(<em>tabsize=8</em>)</td>
<td>返回一个新字符串，把字符串中的制表符(\t)替换成tabsize个空格，tabsize默认是8</td>
</tr>
<tr>
<td>类型判断</td>
<td>str.isdigit()</td>
...
<td></td>
<td>str.isdecimal()</td>
<td>如果字符串只包含十进制数则返回True，否则返回False</td>
</tr>
<tr>
<td></td>
<td>str.isnumeric()</td>
<td>如果字符串只包含数字字符则返回True，否则返回False</td>
</tr>
<tr>
<td></td>
<td>str.isalpha()</td>
<td>如果字符串至少有一个字符并且所有字符都是字母则返回Trule,否则返回False</td>
</tr>
<tr>
<td></td>
<td>str.isalnum()</td>
<td>如果字符串至少有一个字符并且所有字符都是数字或者字母则返回Trule,否则返回False</td>
</tr>
<tr>
<td></td>
<td>str.isascii()</td>
<td>如果字符串为空或者为ASCII码返回True，否则返回False</td>
</tr>
<tr>
<td></td>
<td>更多类型判断...</td>
...
<p><strong>（5）str和byte转换</strong></p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8 -*-</span>
...
</code></pre></div><h3 id="字典-dict" tabindex="-1"><a class="header-anchor" href="#字典-dict" aria-hidden="true">#</a> 字典(dict)</h3>
<p>文档：<a href="https://docs.python.org/zh-cn/3/library/stdtypes.html#dict" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3/library/stdtypes.html#dict<ExternalLinkIcon/></a></p>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">)</span> 普通方式创建的字典: True
...
</code></pre></div><p><strong>字典方法</strong></p>
<table>
<thead>
<tr>
<th>分类</th>
...
<td>直接赋值，没有即新增，有的话为覆盖</td>
</tr>
<tr>
<td></td>
<td>dict.update(dict)</td>
<td>字典合并</td>
</tr>
<tr>
<td></td>
<td>dict.setdefault(k, [value])</td>
<td>k存在则返回v的值，否则设置dict[k] = value，并返回value的值</td>
</tr>
<tr>
<td>删除</td>
<td>del dict[key]</td>
...
<td></td>
<td>dict.pop(key)</td>
<td>弹出value值，如果key未找到则抛出KeyError</td>
</tr>
<tr>
<td></td>
<td>dict.popitem ()</td>
...
<td>查找</td>
<td>dict[key]</td>
<td>返回value值，如果key不存在，则抛出KeyError</td>
</tr>
<tr>
<td></td>
<td>dict.get(key, [default])</td>
<td>返回value值，如果key不存在，则返回default值或None</td>
</tr>
<tr>
<td>拷贝</td>
<td>dict.copy()</td>
...
<h3 id="可变集合-set" tabindex="-1"><a class="header-anchor" href="#可变集合-set" aria-hidden="true">#</a> 可变集合(set)</h3>
<p>文档：<a href="https://docs.python.org/zh-cn/3/library/stdtypes.html#set" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3/library/stdtypes.html#set<ExternalLinkIcon/></a></p>
...
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token punctuation">{</span><span class="token number">1</span><span class="token punctuation">}</span>
...
</code></pre></div><p><strong>集合方法</strong></p>
<table>
<thead>
<tr>
<th>分类</th>
...
<td>删除元素</td>
<td>.remove(value)</td>
<td>删除元素，如果元素不存在则抛出KeyError错误</td>
</tr>
<tr>
<td></td>
<td>.clear()</td>
...
<td>集合操作</td>
<td>.union(set)</td>
<td>返回一个新集合，是两个集合的并集</td>
</tr>
<tr>
<td></td>
<td>.intersection(set)</td>
<td>返回一个新集合，是两个集合的交集</td>
</tr>
<tr>
<td></td>
<td>.intersection_update(set)</td>
<td><strong>就地修改原集合，是两个集合的交集</strong></td>
</tr>
<tr>
<td></td>
<td>.difference(set)</td>
<td>返回一个新集合，是原集合独有的元素</td>
</tr>
<tr>
<td></td>
<td>.difference_update(set)</td>
<td><strong>就地修改原集合，是原集合独有的元素</strong></td>
</tr>
<tr>
<td></td>
<td>.issubset(set)</td>
<td>返回一个布尔值，判断原集合是否是新集合的子集</td>
</tr>
<tr>
<td></td>
<td>.issuperset(set)</td>
<td>返回一个布尔值，判断原集合是否是新集合的父集</td>
</tr>
<tr>
<td></td>
<td>.isdisjoint(set)</td>
<td>返回一个布尔值，判断两个集合是否【没有交集】</td>
</tr>
<tr>
<td></td>
<td>.symmetric_difference(set)</td>
<td>返回一个新集合，取两个集合不一样的所有元素</td>
</tr>
<tr>
<td></td>
<td>.symmetric_difference_update(set)</td>
<td><strong>就地修改原集合，取两个集合不一样的所有元素</strong></td>
</tr>
</tbody>
</table>
<h3 id="不可变集合-frozenset" tabindex="-1"><a class="header-anchor" href="#不可变集合-frozenset" aria-hidden="true">#</a> 不可变集合(frozenset)</h3>
<p>文档：<a href="https://docs.python.org/zh-cn/3/library/stdtypes.html#frozenset" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3/library/stdtypes.html#frozenset<ExternalLinkIcon/></a></p>
<p>和<code v-pre>set</code>类似，只是少了许多方法，用法都是一样的</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8 -*-</span>
...
</code></pre></div><h3 id="可变对象和不可变对象" tabindex="-1"><a class="header-anchor" href="#可变对象和不可变对象" aria-hidden="true">#</a> 可变对象和不可变对象</h3>
<p><strong>引用计数模型</strong></p>
<p><img src="https://tuchuang-1257805459.cos.ap-shanghai.myqcloud.com/698051107556314373.png" alt="698051107556314373"></p>
<p>代码示例</p>
<details class="custom-container details"><summary>点击查看完整代码和输出结果</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8 -*-</span>
...
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code>代码: a <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token number">1</span>, <span class="token number">2</span>, <span class="token number">3</span><span class="token punctuation">]</span>
...
<p>💡 不同Python版本对于一些细节处理并不一致，了解即可</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8 -*-</span>
...
<span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">'----------------------------------------------------------------------------------------------------'</span><span class="token punctuation">)</span>
</code></pre></div><p>关于Python更多“神奇”的操作，可以参考   <a href="https://github.com/robertparley/wtfpython-cn" target="_blank" rel="noopener noreferrer">https://github.com/robertparley/wtfpython-cn<ExternalLinkIcon/></a></p>
...
</code></pre></div><p><strong>关于哈希</strong></p>
<ul>
<li>可哈希 == 不可变对象</li>
<li>不可哈希 == 可变对象</li>
</ul>
...
</code></pre></div><p><strong>深浅拷贝</strong></p>
<p>浅拷贝</p>
<p>说明：拷贝后仅仅是最顶层开辟了新的空间，里层的元素内存地址还是一样的</p>
<p>方法：各类对象(list<code v-pre>/dict</code>)等的copy方法、对象[::]、copy.copy方法</p>
<p>深拷贝</p>
<p>说明：除了顶层拷贝还对子元素也进行了拷贝（本质上递归浅拷贝），两个元素真正意义上的互不影响</p>
<p>方法：copy.deepcopy()</p>
<h3 id="基本数据类型对比" tabindex="-1"><a class="header-anchor" href="#基本数据类型对比" aria-hidden="true">#</a> <strong>基本数据类型对比</strong></h3>
<table>
<thead>
<tr>
<th>数据类型</th>
...
<h2 id="三、函数" tabindex="-1"><a class="header-anchor" href="#三、函数" aria-hidden="true">#</a> 三、函数</h2>
<h3 id="函数说明" tabindex="-1"><a class="header-anchor" href="#函数说明" aria-hidden="true">#</a> 函数说明</h3>
<p>使用<code v-pre>def</code>定义函数，<code v-pre>return</code>指定返回值，若没有指定返回值，会隐式返回<code v-pre>return None</code>，举例说明</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
<h4 id="常见形式和坑" tabindex="-1"><a class="header-anchor" href="#常见形式和坑" aria-hidden="true">#</a> 常见形式和坑</h4>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
</code></pre></div><h4 id="可变参数和不可变参数" tabindex="-1"><a class="header-anchor" href="#可变参数和不可变参数" aria-hidden="true">#</a> 可变参数和不可变参数</h4>
<p><code v-pre>*args</code>和<code v-pre>**kwargs</code>表示可变参数，在函数内部args是一个元祖，kwargs是一个字典</p>
<p>这两个参数不传递的话就使用默认值，即空元祖和空字典</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
</code></pre></div><h4 id="仅限位置形参-positional-only-和仅限关键字形参-keyword-only" tabindex="-1"><a class="header-anchor" href="#仅限位置形参-positional-only-和仅限关键字形参-keyword-only" aria-hidden="true">#</a> 仅限位置形参(positional-only)和仅限关键字形参(keyword-only)</h4>
<p>仅限位置形参就是说只能使用<code v-pre>add(1,2)</code>这种形式来传递参数，</p>
<p>仅限关键字形参就是只能使用<code v-pre>add(x=1, y=2)</code>来调用参数（顺序可任意调整）</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
</code></pre></div><h4 id="看一个比较复杂的函数定义" tabindex="-1"><a class="header-anchor" href="#看一个比较复杂的函数定义" aria-hidden="true">#</a> 看一个比较复杂的函数定义</h4>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
</code></pre></div><h3 id="函数作用域和legb" tabindex="-1"><a class="header-anchor" href="#函数作用域和legb" aria-hidden="true">#</a> 函数作用域和<code v-pre>LEGB</code></h3>
<h4 id="作用域" tabindex="-1"><a class="header-anchor" href="#作用域" aria-hidden="true">#</a> 作用域</h4>
<ul>
<li>
<p>函数内部定义的变量为 局部变量，在函数外部不能直接使用</p>
</li>
<li>
<p>函数内部可以使用 全局变量，但是具有只读属性，如果需要修改 需要先使用<code v-pre>global 变量名</code>，否则会报错</p>
<p><code v-pre>UnboundLocalError: local variable 'x' referenced before assignment</code></p>
</li>
<li>
<p>如果函数<code v-pre>fn1</code>内定义一个函数<code v-pre>fn2</code>，那么</p>
<ul>
<li><code v-pre>fn2</code>对全局变量和<code v-pre>fn1</code>中的变量具有只读属性</li>
<li><code v-pre>f2</code>要修改全局变量使用<code v-pre>global 变量名</code></li>
<li><code v-pre>f2</code>要修改<code v-pre>f1</code>变量要使用<code v-pre>nonlocal 变量名</code></li>
<li>如果<code v-pre>f2</code>中继续嵌套函数，那么规则与上述类似</li>
</ul>
</li>
</ul>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
...
</code></pre></div><p>如果上面函数都看懂了的话，还有一个问题需要特别注意，为了方便起见写了一个最简单的形式，请看如下代码</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
</code></pre></div><p>上面代码会报错<code v-pre>UnboundLocalError: local variable 'x' referenced before assignment</code>，这是什么鬼呢？</p>
<p>因为函数在定义之后，未调用之前，Python解释器就知道了<code v-pre>print(x)</code>中x用的是函数内部的x，因为第二行定义了<code v-pre>x=100</code>，</p>
<p>但是由于是先使用后定义，那就肯定会报错了，所以我们需要注意，如果函数内部要定义变量的话，一定要先定义再使用，当然了，函数外部也是先定义再使用</p>
<h4 id="思考题-加深理解" tabindex="-1"><a class="header-anchor" href="#思考题-加深理解" aria-hidden="true">#</a> 思考题-加深理解</h4>
<p>请思考这个是为什么？，如果不明白可以随时联系我</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
outer<span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre></div><p>使用嵌套函数同样可以保存函数的状态，至此已经有两种方式可以保存函数状态，请看如下代码</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
fn2<span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token comment"># 函数已经调用过了</span>
fn2<span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token comment"># 函数已经调用过了</span>
</code></pre></div><h4 id="变量搜索顺序legb" tabindex="-1"><a class="header-anchor" href="#变量搜索顺序legb" aria-hidden="true">#</a> 变量搜索顺序<code v-pre>LEGB</code></h4>
<ul>
<li><code v-pre>Local</code> 本地作用域</li>
<li><code v-pre>Enclosing</code> 嵌套函数的外部函数的命名空间</li>
<li><code v-pre>Global</code> 全局作用域</li>
<li><code v-pre>Build-in</code> 内置模块命名空间</li>
</ul>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
'''</span>
</code></pre></div><h3 id="类型注解" tabindex="-1"><a class="header-anchor" href="#类型注解" aria-hidden="true">#</a> 类型注解</h3>
<p>类型注解，用来说明参数是何种类型的对象，这只是说明，目的是方便开发人员，并不是强制一定要传入指定类型的对象</p>
<p>函数注解信息保存在<code v-pre>__annotations__</code>字典中</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">add</span><span class="token punctuation">(</span>x<span class="token punctuation">:</span><span class="token builtin">int</span><span class="token punctuation">,</span> y<span class="token punctuation">:</span><span class="token builtin">int</span><span class="token punctuation">)</span> <span class="token operator">-</span><span class="token operator">></span> <span class="token builtin">int</span><span class="token punctuation">:</span>
    <span class="token keyword">return</span> x <span class="token operator">+</span> y
...
</code></pre></div><h3 id="函数签名" tabindex="-1"><a class="header-anchor" href="#函数签名" aria-hidden="true">#</a> 函数签名</h3>
<p>函数签名，说白了就是描述函数参数的东西，除了写框架、调试器等，基本上我们也用不到</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
参数注解: None
'''</span>    
</code></pre></div><h3 id="匿名函数" tabindex="-1"><a class="header-anchor" href="#匿名函数" aria-hidden="true">#</a> 匿名函数</h3>
<p>匿名函数，顾名思义，就是没有名字的函数，使用<code v-pre>lambda</code>定义</p>
<p>匿名函数通常和<code v-pre>filter</code>、<code v-pre>map</code>、<code v-pre>sorted</code>等高阶函数配合使用</p>
<p>匿名函数举例</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
<p>参考 <a href="https://docs.python.org/zh-cn/3/library/functions.html" target="_blank" rel="noopener noreferrer">https:<code v-pre>//docs</code>.python.org<code v-pre>/zh-cn/3/library/functions</code>.html<ExternalLinkIcon/></a></p>
<h3 id="内置函数库-functools" tabindex="-1"><a class="header-anchor" href="#内置函数库-functools" aria-hidden="true">#</a> 内置函数库 <code v-pre>functools</code></h3>
<h4 id="reduce" tabindex="-1"><a class="header-anchor" href="#reduce" aria-hidden="true">#</a> reduce</h4>
<p>用传给 reduce 中的函数 function（有两个参数）先对集合中的第 1、2 个元素进行操作，</p>
<p>得到的结果再与第三个数据用 function 函数运算，最后得到一个结果</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
</code></pre></div><h4 id="partial" tabindex="-1"><a class="header-anchor" href="#partial" aria-hidden="true">#</a> partial</h4>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
</code></pre></div><h4 id="partialmethod" tabindex="-1"><a class="header-anchor" href="#partialmethod" aria-hidden="true">#</a> partialmethod</h4>
<p>和partial类似，partial用于普通函数，<code v-pre>partialmethod</code>用于类方法</p>
<h4 id="cached-property" tabindex="-1"><a class="header-anchor" href="#cached-property" aria-hidden="true">#</a> cached_property</h4>
<p>计算过后便被缓存</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
</code></pre></div><h4 id="lru-cache" tabindex="-1"><a class="header-anchor" href="#lru-cache" aria-hidden="true">#</a> lru_cache</h4>
<ul>
<li>lru是什么？LRU是Least Recently Used的缩写，即最近最少使用，是一种常用的页面置换算法</li>
<li>函数签名：lru_cache(maxsize=128, typed=False)</li>
<li>maxsize代表最大可以缓存128个，如果设置为None代表禁用LRU功能，并且缓存可以无限增长，设置为2的幂时性能最好</li>
<li>typed 如果设置为True，则不同类型的函数参数将单独缓存，比如f(3)和f(3.0)将被分别缓存</li>
</ul>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
</code></pre></div><h4 id="cmp-to-key" tabindex="-1"><a class="header-anchor" href="#cmp-to-key" aria-hidden="true">#</a> cmp_to_key</h4>
<p>比较函数，需传入两个值x，y，当x &gt; y时返回1，等于时返回0，否则返回-1</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
</code></pre></div><h4 id="total-ordering" tabindex="-1"><a class="header-anchor" href="#total-ordering" aria-hidden="true">#</a> total_ordering</h4>
<p>类装饰器，实现其中一个： <code v-pre>__lt__()</code>, <code v-pre>__le__()</code>, <code v-pre>__gt__()</code>, <code v-pre>__ge__()</code>，自动实现剩余方法</p>
<p>要求此类需要实现<code v-pre>__eq__</code></p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
</code></pre></div><h3 id="递归函数" tabindex="-1"><a class="header-anchor" href="#递归函数" aria-hidden="true">#</a> 递归函数</h3>
<ul>
<li>
<p>Python对递归深度做了限制，以保护解释器，超过限制抛出<code v-pre>RecursionError:maxinum recursion depth exceeded</code></p>
</li>
<li>
<p>使用<code v-pre>sys.getrecursionlimit()</code>获取递归深度，默认为<code v-pre>1000</code>；</p>
</li>
<li>
<p><code v-pre>使用sys.setrecursionlimit(n)设置递归深度</code>，注意不要设置的太大，否则会导致栈溢出，</p>
<p>报错<code v-pre>OverflowError: signed integer ``is</code> <code v-pre>greater than maximum</code></p>
</li>
</ul>
<p>一个递归+缓存版的费布那切数列</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
...
</code></pre></div><h3 id="高阶函数" tabindex="-1"><a class="header-anchor" href="#高阶函数" aria-hidden="true">#</a> 高阶函数</h3>
<p>高阶函数指的是可以将一个函数作为一个形参传递给一个函数 或 返回值是一个函数，这个函数就称为高阶函数</p>
<h4 id="sorted" tabindex="-1"><a class="header-anchor" href="#sorted" aria-hidden="true">#</a> sorted</h4>
<p>sorted 排序函数，key指定自定义排序规则，reverse可以反转结果，返回列表</p>
<p>函数签名</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token builtin">sorted</span><span class="token punctuation">(</span>iterable<span class="token punctuation">,</span> <span class="token operator">/</span><span class="token punctuation">,</span> <span class="token operator">*</span><span class="token punctuation">,</span> key<span class="token operator">=</span><span class="token boolean">None</span><span class="token punctuation">,</span> reverse<span class="token operator">=</span><span class="token boolean">False</span><span class="token punctuation">)</span>
</code></pre></div><p>示例</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
</code></pre></div><h4 id="filter" tabindex="-1"><a class="header-anchor" href="#filter" aria-hidden="true">#</a> filter</h4>
<p>filter 筛选指定元素，函数可以为None时代表从序列中筛选出为真的元素，返回一个filter对象</p>
<p>使用filter过滤后，返回新的元素个数可能会减少</p>
<p>函数签名</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token builtin">filter</span><span class="token punctuation">(</span>function <span class="token keyword">or</span> <span class="token boolean">None</span><span class="token punctuation">,</span> iterable<span class="token punctuation">)</span> <span class="token operator">-</span><span class="token operator">-</span><span class="token operator">></span> <span class="token builtin">filter</span> <span class="token builtin">object</span>
</code></pre></div><p>示例</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
</code></pre></div><h4 id="map" tabindex="-1"><a class="header-anchor" href="#map" aria-hidden="true">#</a> map</h4>
<p>将序列的每个元素都作用在函数上，返回一个map object</p>
<p>使用map后，新对象的元素个数不会变，值一般都会变</p>
<p>函数签名</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token builtin">map</span><span class="token punctuation">(</span>func<span class="token punctuation">,</span> <span class="token operator">*</span>iterables<span class="token punctuation">)</span> <span class="token operator">-</span><span class="token operator">-</span><span class="token operator">></span> <span class="token builtin">map</span> <span class="token builtin">object</span>
</code></pre></div><p>举例</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
starmap
</code></pre></div><p><code v-pre>starmap</code>与map类似，不同的是对于多个可迭代对象的处理方式</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
</code></pre></div><h3 id="装饰器" tabindex="-1"><a class="header-anchor" href="#装饰器" aria-hidden="true">#</a> 装饰器</h3>
<h4 id="柯里化-currying" tabindex="-1"><a class="header-anchor" href="#柯里化-currying" aria-hidden="true">#</a> 柯里化(Currying)</h4>
<p>将原来接受2个参数的函数变成新的接受一个参数的函数的过程。新的函数是接受原有函数第二个参数的函数，比如：</p>
<p>原函数为: <code v-pre>add(1, 2)</code></p>
<p>柯里化后: <code v-pre>add(1)(2)</code></p>
<p>柯里化简单举例</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
</code></pre></div><h4 id="闭包-closure" tabindex="-1"><a class="header-anchor" href="#闭包-closure" aria-hidden="true">#</a> 闭包(Closure)</h4>
<p>闭包就是函数中再嵌套一个函数，内层函数中使用了外层函数的自有变量，就产生了闭包</p>
<p>外层函数<code v-pre>__closure__</code>属性是一个cell对象的元祖，每个cell对象的cell_contents属性对应产生闭包的自有变量的值</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
</code></pre></div><h4 id="装饰器-1" tabindex="-1"><a class="header-anchor" href="#装饰器-1" aria-hidden="true">#</a> 装饰器</h4>
<p>无参装饰器</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># --*-- coding:utf-8 --*--</span>
...
<span class="token keyword">print</span><span class="token punctuation">(</span>add<span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre></div><p>带参装饰器，需要再饰器函数的第一层再嵌套一个函数</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token keyword">import</span> time
...
<span class="token keyword">print</span><span class="token punctuation">(</span>add<span class="token punctuation">(</span><span class="token number">1</span> <span class="token punctuation">,</span><span class="token number">2</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre></div><p>装饰器的副作用：部分属性会被覆盖,比如 <code v-pre>__name__</code>, <code v-pre>__doc__</code></p>
<p>使用装饰器<code v-pre>functools.wraps(func)</code> 或 函数<code v-pre>functools.update_wrapper(wrapper, func)</code> 可以消除这种影响</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">timer</span><span class="token punctuation">(</span>start_time<span class="token operator">=</span><span class="token number">3</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
    <span class="token keyword">def</span> <span class="token function">_timer</span><span class="token punctuation">(</span>func<span class="token punctuation">)</span><span class="token punctuation">:</span>
        ...
        <span class="token keyword">return</span> wrapper
    <span class="token keyword">return</span> _timer
</code></pre></div><h2 id="-2" tabindex="-1"><a class="header-anchor" href="#-2" aria-hidden="true">#</a> </h2>
<h2 id="四、多线程" tabindex="-1"><a class="header-anchor" href="#四、多线程" aria-hidden="true">#</a> 四、多线程</h2>
<h3 id="并发和并行" tabindex="-1"><a class="header-anchor" href="#并发和并行" aria-hidden="true">#</a> 并发和并行</h3>
<p>并发（Concurrent）：在同一时间点，一颗CPU核心交替做两件或多件事</p>
<p>并行（Parallel）：同一时间点，两颗或多颗CPU核心同时做两件或多件事</p>
<p>单单只看这些概念还是让人摸不着头脑，我们深入理解一下：</p>
<ul>
<li>
<p>在只有一颗CPU核心的处理器上面是无法实现并行的，但是可以实现并发</p>
</li>
<li>
<p>并行是提高并发的一种手段</p>
</li>
<li>
<p>由于CPython特殊的GIL锁，导致CPython不能实现并行，解决办法可以使用多进程来实现并行，</p>
<p>也可以使用PyPy等移除掉GIL的第三方解释器来执行（这又是一个比较深的坑）</p>
</li>
</ul>
<h3 id="高并发解决方案" tabindex="-1"><a class="header-anchor" href="#高并发解决方案" aria-hidden="true">#</a> 高并发解决方案</h3>
<p>上面我们讲的都是在编程语言范围内的并发，而在一个项目中，高并发的本质问题往往在于数据库能够承载的并发是有限的。解决高并发的关键就在于降低单库的连接数。</p>
<p>通常我们可以有以下几种方法：</p>
<ul>
<li>使用缓存，缓存命中便不会再去请求数据库</li>
<li>系统拆分，每个业务使用独立的一个数据库实例</li>
<li>读写分离，对同一个数据库进一步拆分，读和写分散在不同的数据库实例上</li>
<li>MQ削峰，服务端限速执行</li>
<li>限流操作，比如令牌桶等，超出则丢弃</li>
</ul>
<blockquote>
<p>实际情况中要根据项目的特性，是读多写少还是读少写多，综合不同的手段来达到高并发的目的</p>
</blockquote>
<h3 id="线程说明" tabindex="-1"><a class="header-anchor" href="#线程说明" aria-hidden="true">#</a> 线程说明</h3>
<ul>
<li>线程是CPU调度的最小单元</li>
<li>每个可执行程序都会有一个主线程，主线程一般我们都用来做协调工作，由主线程来创建其他线程称为工作线程</li>
<li>线程之间数据共享</li>
<li>线程状态
<ul>
<li>就绪(Ready)：线程能够运行但是还没有开始运行，等待被调度</li>
<li>运行(Running)：线程一旦调度就处于运行中</li>
<li>阻塞(Blocked)：线程等待外部事件而无法运行，比如I<code v-pre>/O</code>等待</li>
<li>终止(Teminated)：线程退出</li>
</ul>
</li>
<li>工作线程一旦启动，不可暂停和取消，除非代码运行完成或抛出异常而停止；工作线程崩溃不影响主线程正常运行</li>
</ul>
<h3 id="cpython线程使用场景" tabindex="-1"><a class="header-anchor" href="#cpython线程使用场景" aria-hidden="true">#</a> CPython线程使用场景</h3>
<p>线程是最出名的实现并发和并行的方式之一，但是在CPython中由于GIL的存在，线程只能实现并发，而不能实现并行。</p>
<p>可以说CPython的线程并不是真正的线程，但是它在某些场景下仍旧可以为我们的代码提速，其原理在于：</p>
<ul>
<li>对于CPU密集型的应用，由于线程会一直霸占CPU，除非线程执行完成或主动交出控制权，所以使用多线程一般会导致程序变慢（线程创建和销毁需要开销）</li>
<li>对于IO密集型应用，遇到IO阻塞时系统会自动进行线程切换，所以可以极大的提高程序效率</li>
</ul>
...
<span class="token keyword">for</span> i <span class="token keyword">in</span> <span class="token builtin">range</span><span class="token punctuation">(</span><span class="token number">5</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
    ...
    t<span class="token punctuation">.</span>start<span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre></div><h3 id="线程属性" tabindex="-1"><a class="header-anchor" href="#线程属性" aria-hidden="true">#</a> 线程属性</h3>
<p>Thread类签名</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">__init__</span><span class="token punctuation">(</span>self<span class="token punctuation">,</span> group<span class="token operator">=</span><span class="token boolean">None</span><span class="token punctuation">,</span> target<span class="token operator">=</span><span class="token boolean">None</span><span class="token punctuation">,</span> name<span class="token operator">=</span><span class="token boolean">None</span><span class="token punctuation">,</span>
...
args	线程函数参数，是一个元祖
daemon	后面有讲解
</code></pre></div><p>Thread实例属性和方法</p>
<table>
<thead>
<tr>
<th>属性/方法</th>
...
<tr>
<td>start()</td>
<td>执行任务（启动新线程）,start会启动新线程然后调用run方法</td>
</tr>
<tr>
<td>run()</td>
<td>执行任务（在当前线程中），run方法会执行具体的任务</td>
</tr>
<tr>
<td>name/getName()</td>
<td>线程名，默认以Thread-1、Thread-2形式命名</td>
</tr>
<tr>
<td>setName()</td>
<td>设置线程名称</td>
...
<tr>
<td>ident</td>
<td>线程ID，非0整数，线程启动后才会有ID，否则为None。线程退出，此ID依旧可以访问。此ID可以重复使用</td>
</tr>
<tr>
<td>is_alive()</td>
<td>返回线程是否还活着，等同于.isAlive()</td>
</tr>
</tbody>
</table>
<p>threading模块属性和方法</p>
<table>
<thead>
<tr>
<th>属性/方法</th>
...
<tr>
<td>enumerate()</td>
<td>返回所有的活着的线程列表，不包括未开始和已终止的线程</td>
</tr>
</tbody>
</table>
<h3 id="线程安全" tabindex="-1"><a class="header-anchor" href="#线程安全" aria-hidden="true">#</a> 线程安全</h3>
<p>线程执行一段代码的时候，这段代码要么不执行，要么一定会执行完(执行过程中不会切换到其他线程)，这段代码就称为线程安全</p>
<p>（1）直接使用<code v-pre>print</code>函数是线程不安全的，但通过修改使用方式，可以达到线程安全；<code v-pre>logging</code>是线程安全，更推荐使用<code v-pre>logging</code>来代替<code v-pre>print</code></p>
<p><code v-pre>print</code>线程安全说明</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">"hello world"</span><span class="token punctuation">)</span>            <span class="token comment"># 线程不安全</span>
...
<span class="token keyword">for</span> i <span class="token keyword">in</span> <span class="token builtin">range</span><span class="token punctuation">(</span><span class="token number">5</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
    ...
    t<span class="token punctuation">.</span>start<span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre></div><p><img src="https://tuchuang-1257805459.cos.ap-shanghai.myqcloud.com/image-20220330204518155.png" alt="image-20220330204518155"></p>
<p>（2）<code v-pre>queue</code>是线程安全的，但是下面的代码是线程不安全的</p>
<p><code v-pre>queue</code>线程不安全原理</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token keyword">if</span> q<span class="token punctuation">.</span>qsize<span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">></span> <span class="token number">0</span><span class="token punctuation">:</span>
...
</code></pre></div><p><code v-pre>queue</code>线程安全演示</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*-coding:utf-8-*-</span>
...
</code></pre></div><h3 id="daemon" tabindex="-1"><a class="header-anchor" href="#daemon" aria-hidden="true">#</a> daemon</h3>
<p>设置线程daemon为False后，当主线程执行结束后，要等待非daemon线程执行完成</p>
<p>设置daemon为True后，当主线程执行结束后，daemon线程也会立即退出</p>
<p>子线程的daemon的值从父线程中继承来，父线程如果不设置默认为False</p>
<p>daemon相关方法</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td>threading.Thread(...., daemon=True)</td>
<td>创建线程时设置daemon属性</td>
</tr>
<tr>
<td>线程.setDaemon(True)</td>
<td>线程创建完成后，也可以设置daemon属性，必须在start之前</td>
</tr>
<tr>
<td>线程.isDaemon()/daemon</td>
<td>返回daemon状态</td>
</tr>
</tbody>
</table>
...
<li>
<p>主线程工作才有用的线程，如主线程维护这公共资源，主线程已经清理了，准备退出，而工作线程使用这些资源已经没有意义了，一起退出最合适</p>
</li>
</ul>
<p>daemon示例</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
...
<span class="token comment">#     End</span>
</code></pre></div><h3 id="join阻塞线程" tabindex="-1"><a class="header-anchor" href="#join阻塞线程" aria-hidden="true">#</a> join阻塞线程</h3>
<p>如果想让所有线程工作完毕后，主线程再执行代码，此时可以使用<code v-pre>线程.join()</code>来等待线程执行完毕</p>
<p>join作用</p>
<ul>
<li>阻塞线程直到执行完毕</li>
<li>它还可以设置超时时间，当超过超时时间，不管线程是否执行完毕，都会向下执行</li>
<li><code v-pre>join</code>无视<code v-pre>daemon</code>的值</li>
</ul>
<p>将<code v-pre>daemon</code>代码改造一下，使代码最后再输出<code v-pre>End</code></p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*-coding:utf-8-*-</span>
...
<span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">"End"</span><span class="token punctuation">)</span>
</code></pre></div><h3 id="线程锁" tabindex="-1"><a class="header-anchor" href="#线程锁" aria-hidden="true">#</a> 线程锁</h3>
<p>Lock相关类：</p>
<ul>
<li>
<p>Lock：独占锁或叫做互斥锁，同一时间只有一个线程能获取到锁</p>
</li>
<li>
<p>RLock：可重入锁，同一时间只有一个线程能获取到锁，在同一个线程内可多次acquire()，但也需要执行相同次数的release()</p>
</li>
</ul>
<p>lock实例方法</p>
<table>
...
<tbody>
<tr>
<td>acquire(blocking, timeout)</td>
<td>尝试获取锁，获取成功返回True，获取失败的话：<br />（1）默认会一直阻塞<br />（2）如果指定blocking为False，直接返回False，表示获取锁失败<br />（3）如果指定了timeout，那么超时以后返回False</td>
</tr>
<tr>
<td>release()</td>
<td>释放锁</td>
...
<tr>
<td>locked()</td>
<td>查看是否上锁，已上锁返回True，否则返回False（注意RLOCK实例没有这个方法）</td>
</tr>
</tbody>
</table>
<p>死锁和RLOCK</p>
<p>连续两次acquire请求会导致死锁，因为第一次获得锁之后还没有释放时，第二次acquire请求紧接着就到来，</p>
<p>但是acquire会让程序阻塞，无法执行release()，这就导致锁永远无法释放，就像下面这样</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code>Lock<span class="token punctuation">.</span>acquire<span class="token punctuation">(</span><span class="token punctuation">)</span>
...
Lock<span class="token punctuation">.</span>release<span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre></div><p>RLock就不存在上面提到的死锁问题，只需要保证有多少次acquire()，就有多少次release()即可</p>
<p>Lock演示</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*-coding:utf-8-*-</span>
...
<span class="token comment"># End</span>
</code></pre></div><h3 id="线程局部变量" tabindex="-1"><a class="header-anchor" href="#线程局部变量" aria-hidden="true">#</a> 线程局部变量</h3>
<p>创建一个全局变量<code v-pre>request = local()</code>，使用多线程对<code v-pre>request</code>进行修改时，会先将request拷贝到自身线程中一份，不会影响到全局和其他线程中的<code v-pre>request</code></p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*-coding:utf-8-*-</span>
...
<span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">"End"</span><span class="token punctuation">)</span>
</code></pre></div><h3 id="线程同步-事件event" tabindex="-1"><a class="header-anchor" href="#线程同步-事件event" aria-hidden="true">#</a> 线程同步 - 事件Event</h3>
<p>Event是线程通信间最简单的实现，使用一个变量flag，通过flag的True或False变化来执行不同操作</p>
<p>Event变化会通知到所有线程</p>
<p>Event实例方法</p>
<table>
<thead>
...
<tr>
<td>is_set()</td>
<td>新创建的event或使用<code v-pre>clear</code>()后为False，当设置<code v-pre>set</code>()后返回True</td>
</tr>
<tr>
<td>wait(timeout=None)</td>
<td>等待，满足以下条件后立即执行：<br />（1）当调用<code v-pre>set</code>()后立即执行，此时wait返回值为True<br />（2）当超时后立即执行，此时wait返回值为False</td>
</tr>
</tbody>
</table>
<p>Event演示</p>
...
</code></pre></div><h3 id="event应用-延迟器-timer" tabindex="-1"><a class="header-anchor" href="#event应用-延迟器-timer" aria-hidden="true">#</a> Event应用 - 延迟器 Timer</h3>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*-coding:utf-8-*-</span>
...
</code></pre></div><h3 id="线程同步-条件变量condition" tabindex="-1"><a class="header-anchor" href="#线程同步-条件变量condition" aria-hidden="true">#</a> 线程同步 - 条件变量Condition</h3>
<p>Condition内部会维护一个锁（默认是RLock），获取到锁的线程使用notify机制来通知（或称为唤醒）其他线程（1个或多个），然后使用wait释放锁并进入等待，当自身被其他线程通知（或唤醒）时，又会重新获取锁，继续向下执行</p>
<p>Condition实例方法</p>
<table>
<thead>
<tr>
...
<tr>
<td>acquire(blocking, timeout)</td>
<td>与RLock实例的acquire方法一致</td>
</tr>
<tr>
<td>release()</td>
<td>与RLock实例的release方法一致</td>
</tr>
<tr>
<td>notify(n=1)</td>
<td>唤醒一个或多个线程</td>
...
<tr>
<td>wait(timeout=None)</td>
<td>进入等待状态（这会释放锁），直到被唤醒或超时（又会重新获取锁），被唤醒返回True，超时返回False<br />如果未获得锁就使用wait，则报错<code v-pre>RuntimeError: cannot wait on un-acquired lock</code></td>
</tr>
<tr>
<td>wait_for(predicate, timeout=None)</td>
<td>wait_for是更灵活的一种wait方式，predicate需要指定一个可调用对象，<br />（1）当predicate()返回True，则继续往下执行<br />（2）当predicate()返回False，则和wait行为一致了<br />（3）timeout参数含义不变，若超时以后还会调用predicate一次</td>
</tr>
</tbody>
</table>
<p>生产者消费者模型</p>
...
<span class="token keyword">for</span> i <span class="token keyword">in</span> <span class="token builtin">range</span><span class="token punctuation">(</span><span class="token number">9</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
    ...
    t<span class="token punctuation">.</span>start<span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre></div><h3 id="线程同步-barrier" tabindex="-1"><a class="header-anchor" href="#线程同步-barrier" aria-hidden="true">#</a> 线程同步 - Barrier</h3>
<h3 id="线程同步-semaphore" tabindex="-1"><a class="header-anchor" href="#线程同步-semaphore" aria-hidden="true">#</a> 线程同步 - Semaphore</h3>
<h3 id="线程池-threadpoolexecutor" tabindex="-1"><a class="header-anchor" href="#线程池-threadpoolexecutor" aria-hidden="true">#</a> 线程池 - ThreadPoolExecutor</h3>
<p>ThreadPoolExecutor构造参数</p>
<table>
<thead>
<tr>
<th>参数</th>
...
<tr>
<td>max_workers</td>
<td>指定线程池的最大线程数，默认为CPU核数的5倍</td>
</tr>
<tr>
<td>thread_name_prefix</td>
<td>指定线程池中线程的名称前缀</td>
</tr>
</tbody>
</table>
<p>ThreadPoolExecutor实例方法</p>
<table>
<thead>
<tr>
<th>方法</th>
...
<td>提交任务，线程池会分配一个线程迟总任务，返回一个Future实例，如果池已经满了，还可以继续提交</td>
</tr>
<tr>
<td>shutdown(wait=True)</td>
<td>清理池，池中的线程/进程全部杀掉，同时不再接受新提交的任务，<br />如果继续提交会报错<code v-pre>RuntimeError: cannot schedule new futures after shutdown</code></td>
</tr>
</tbody>
</table>
<p>Future实例方法</p>
...
<tr>
<td>done()</td>
<td>如果调用成功执行或取消成功，那么返回True，否则返回False</td>
</tr>
<tr>
<td>cancelled()</td>
<td>如果复用被成功的取消，那么返回True</td>
</tr>
<tr>
<td>running()</td>
<td>如果正在运行且不能被取消，那么返回True</td>
</tr>
<tr>
<td>cancel()</td>
...
<td>取返回的结果，timeout为None,一直等待返回，超时抛出concurrent.futures.TimeoutError异常</td>
</tr>
<tr>
<td>exception(timeout=None)</td>
<td>取返回的异常，timeout为None,一直等待返回,超时抛出concurrent.futures.TimeoutError异常</td>
</tr>
</tbody>
</table>
<p>线程池简单演示</p>
...
<h2 id="五、协程" tabindex="-1"><a class="header-anchor" href="#五、协程" aria-hidden="true">#</a> 五、协程</h2>
<h3 id="同步和异步" tabindex="-1"><a class="header-anchor" href="#同步和异步" aria-hidden="true">#</a> 同步和异步</h3>
<p>对于一个函数来说，同步指的是函数返回值就是我们想要的最终结果，异步则指不会直接拿到最终结果。</p>
<p>那么异步函数如何拿到最终结果，可以有如下几种方法</p>
<ul>
<li>给异步函数传入一个回调函数，在回调函数中我们可以拿到最终结果</li>
<li>异步函数返回给我们一个中间结果，比如说是一个对象，通过对象的xx方法可以拿到结果</li>
</ul>
<p><span style="color: red;font-weight: bold;">总结：同步/异步就看是否能直接拿到最终结果，需要注意的是与代码运行时长是没有任何关系的</span></p>
<br />
<h3 id="阻塞和非阻塞" tabindex="-1"><a class="header-anchor" href="#阻塞和非阻塞" aria-hidden="true">#</a> 阻塞和非阻塞</h3>
<p>阻塞和非阻塞直接讲并不容易讲清楚，所以这里结合队列做一下说明</p>
<p>阻塞队列</p>
<ul>
<li>入队阻塞：当队列满了之后再入队，则会进行阻塞，直到满足以下情况：
<ul>
<li>若设置了超时时间，入队超时，阻塞结束</li>
<li>当其他线程消费队列数据后导致队列不满，本线程入队成功，阻塞结束</li>
</ul>
</li>
<li>出队阻塞：当队列为空时再出队，则会进行阻塞，直到满足以下情况：
<ul>
<li>若设置了超时时间，出队超时，阻塞结束</li>
<li>当其他线程入队数据后，本线程出队成功，阻塞结束</li>
</ul>
</li>
</ul>
<p>非阻塞队列</p>
...
<li>入队不会阻塞，如何保证不会阻塞：
<ul>
<li>不考虑内存限制的话，最简单的方法就是不设置队列大小，一直可以放入数据</li>
<li>如果考虑内存限制的话，可以使用双端队列，当队列满了之后再放入数据会先把最开始的数据删掉，然后就能正常放入</li>
</ul>
</li>
<li>出队不会阻塞，如何保证不会阻塞：
<ul>
<li>当队列为空时返回<code v-pre>None</code>或者报错即可</li>
</ul>
</li>
</ul>
<p>阻塞队列-入队阻塞演示</p>
...
<p><span style="color: red;font-weight: bold;">总结：阻塞和非阻塞是指是否能直接能立即返回，需要注意的是与是否能直接拿到最终结果无关</span></p>
<br />
<h3 id="io" tabindex="-1"><a class="header-anchor" href="#io" aria-hidden="true">#</a> IO</h3>
<p>上面所说的同步/异步/阻塞/非阻塞都是概念性的，需要与具体的某个东西结合起来才符合我们的实际情况，比如阻塞队列，而与这些概念关系最密切的当属<code v-pre>IO</code>操作。</p>
<p>IO说简单点就是输入和输出(Input/Output)，往深入说就太太太复杂了，可以参考一下经典的三种IO模型：<code v-pre>select</code>、<code v-pre>poll</code>、<code v-pre>epoll</code></p>
<p>我们来列举常见的一些IO操作</p>
<ul>
<li>磁盘IO：读写文件</li>
<li>网络IO：发送/接收网络请求</li>
<li>与USB设备、显示器、键盘、鼠标等交互产生的IO，比如<code v-pre>print(&quot;hello&quot;)</code>就会涉及到IO操作</li>
</ul>
<p>IO操作类型</p>
<table>
<thead>
...
<tr>
<td>同步阻塞IO</td>
<td>这是我们写代码最常用的方式，这种方式最符合开发者的思考逻辑，但是效率不高<br />比如使用<code v-pre>open</code>函数读写文件，使用第三方库<code v-pre>requests</code>发送网络请求等</td>
</tr>
<tr>
<td>同步非阻塞IO</td>
<td>一般不用，不在讨论范围内</td>
...
<tr>
<td>异步非阻塞IO</td>
<td>我们将要学习的协程，就是用来实现异步非阻塞IO，相比同步阻塞IO，代码会难写一些，但是效率更高</td>
</tr>
</tbody>
</table>
<h3 id="协程概念" tabindex="-1"><a class="header-anchor" href="#协程概念" aria-hidden="true">#</a> 协程概念</h3>
<h3 id="协程基本使用" tabindex="-1"><a class="header-anchor" href="#协程基本使用" aria-hidden="true">#</a> 协程基本使用</h3>
<p>官方文档：<a href="https://docs.python.org/zh-cn/3.9/library/asyncio.html" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.9/library/asyncio.html<ExternalLinkIcon/></a></p>
<h4 id="定义协程函数" tabindex="-1"><a class="header-anchor" href="#定义协程函数" aria-hidden="true">#</a> 定义协程函数</h4>
<p>使用<code v-pre>async</code>关键字定义的函数便是一个协程函数</p>
<h4 id="运行协程函数" tabindex="-1"><a class="header-anchor" href="#运行协程函数" aria-hidden="true">#</a> 运行协程函数</h4>
<p>直接调用协程函数，返回的叫做协程对象</p>
<p>协程对象需要借助外力启动，才能真正执行函数代码，此时有如下几种方法</p>
<ul>
<li>在协程函数外部，使用<code v-pre>asyncio.run(协程对象)</code>，这个是协程执行最高入口点</li>
<li>在协程函数内部，可以使用几下几种方法运行新的协程：
<ul>
<li>使用<code v-pre>await 协程对象</code></li>
<li>使用<code v-pre>await asyncio.create_task(协程对象)</code>并发运行一个或多个协程</li>
</ul>
</li>
</ul>
<blockquote>
<p>await是一个关键字，详细内容参考：可等待对象</p>
</blockquote>
<p>协程函数举例</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*-coding:utf-8-*-</span>
...
</code></pre></div><h4 id="并发运行协程函数" tabindex="-1"><a class="header-anchor" href="#并发运行协程函数" aria-hidden="true">#</a> 并发运行协程函数</h4>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*-coding:utf-8-*-</span>
...
<span class="token comment"># 运行协程函数-方式1, 这里是最高入口点</span>
asyncio<span class="token punctuation">.</span>run<span class="token punctuation">(</span>main<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre></div><h4 id="协程函数的威力-测试网络io" tabindex="-1"><a class="header-anchor" href="#协程函数的威力-测试网络io" aria-hidden="true">#</a> 协程函数的威力 - 测试网络IO</h4>
<p>协程属于异步但其内部编写的代码可能是同步阻塞的，下面以<code v-pre>requests</code>和<code v-pre>aiohttp</code>来做一个演示</p>
<p>安装第三方库</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code>pip <span class="token function">install</span> requests aiohttp
...
</code></pre></div><h4 id="协程函数并不是万能的-测试磁盘io" tabindex="-1"><a class="header-anchor" href="#协程函数并不是万能的-测试磁盘io" aria-hidden="true">#</a> 协程函数并不是万能的 - 测试磁盘IO</h4>
<p>这次我们来读写文件测试，使用非阻塞函数<code v-pre>aiofiles</code>来代替<code v-pre>open</code></p>
<p>安装aiofiles</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code>pip <span class="token function">install</span> aiofiles
</code></pre></div><p>代码演示</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*-coding:utf-8-*-</span>
...
</code></pre></div><p>可以看到确实有效果，但是提速并不明显</p>
<p>尤其是当我们减少文件数量、减少文件内容的时候，两种方式运行效果几乎一致，甚至有可能出现协程会更慢的情况</p>
<p>这是为什么呢？可能是因为网络IO和磁盘IO的不同导致的。</p>
<h4 id="协程与同步阻塞混合编程" tabindex="-1"><a class="header-anchor" href="#协程与同步阻塞混合编程" aria-hidden="true">#</a> 协程与同步阻塞混合编程</h4>
<p>注入事件循环中的执行器（默认为线程池），后面去讲到</p>
<p>代码演示</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8 -*-</span>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token number">2022</span>-04-04 <span class="token number">12</span>:23:50,691	 <span class="token punctuation">[</span>MainThread, <span class="token number">252956</span><span class="token punctuation">]</span> download_sync  下载完成 <span class="token operator">|</span> 用时: <span class="token number">0.9531307220458984</span>秒
...
</code></pre></div><p>可以看到效果提升还是比较明显</p>
<h3 id="协程深入理解" tabindex="-1"><a class="header-anchor" href="#协程深入理解" aria-hidden="true">#</a> 协程深入理解</h3>
<h4 id="早期的协程执行最高入口" tabindex="-1"><a class="header-anchor" href="#早期的协程执行最高入口" aria-hidden="true">#</a> 早期的协程执行最高入口</h4>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8 -*-</span>
...
</code></pre></div><h4 id="事件循环" tabindex="-1"><a class="header-anchor" href="#事件循环" aria-hidden="true">#</a> 事件循环</h4>
<p>官方文档：<a href="https://docs.python.org/zh-cn/3.9/library/asyncio-eventloop.html" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.9/library/asyncio-eventloop.html<ExternalLinkIcon/></a></p>
<p>看一下官网的描述：</p>
<blockquote>
<p>事件循环是每个 asyncio 应用的核心。 事件循环会运行异步任务和回调，执行网络 IO 操作，以及运行子进程。</p>
</blockquote>
<p>简单来说，事件循环就是一个大循环，用来调度协程对象，可以让我们更精细的控制协程调度</p>
<p><strong>创建和运行</strong></p>
<p>事件循环相关方法</p>
<table>
<thead>
<tr>
...
<tbody>
<tr>
<td>asyncio.new_event_loop()</td>
<td>创建一个事件循环</td>
</tr>
<tr>
<td>asyncio.set_event_loop(loop)</td>
<td>将loop设置为当前OS线程的当前事件循环</td>
</tr>
<tr>
<td><strong>asyncio.get_event_loop()</strong></td>
<td>获取当前事件循环，如果当前没有运行则创建一个新的事件循环</td>
</tr>
<tr>
<td><strong>asyncio.get_running_loop()</strong></td>
<td>返回当前OS线程中正在运行的事件循环，如果没有运行则引发RuntimeError<br />（1）此函数只能由协程或回调来调用。<br />（2）官方更推荐使用这个而不是<code v-pre>get_event_loop</code></td>
</tr>
<tr>
<td>asyncio.get_event_loop_policy()</td>
<td>获取当前事件循环策略</td>
</tr>
<tr>
<td><strong>asyncio.set_event_loop_policy(policy)</strong></td>
<td>设置当前事件循环策略，比如使用<code v-pre>uvloop</code>提供的事件循环策略来加快协程执行速度</td>
</tr>
</tbody>
</table>
<p>事件循环代码演示</p>
...
<p>（1）第一行输出：running=False 说明虽然创建了事件循环，但并未运行</p>
<p>（2）第二行输出：我们又创建了一个事件循环，两个对比一下，发现内存地址并不相同</p>
<p>（3）第三行输出：我们编写的异步代码在第1个事件循环中运行：</p>
<p>​								① running已变成了True，说明事件循环运行起来了</p>
<p>​								② 内存地址与事件循环1相同</p>
<p>（4）第四行输出：我们编写的异步代码在第2个事件循环中运行</p>
</blockquote>
<p><span style="color: red;font-weight: bold;">总结：可以有多个事件循环；协程函数需要在一个具体的事件循环中执行</span></p>
<br />
<p><strong>事件循环实例方法</strong></p>
<table>
<thead>
<tr>
<th>方法</th>
...
<tbody>
<tr>
<td>loop.run_until_complete(future)</td>
<td>运行直到 future ( Future 的实例 )被完成；也可以传入协程对象，会自动处理<br />（1）如果当前事件循环loop处于停止状态(stop)，会自动启动<br />（2）如果当前事件循环loop处于关闭状态(close)，则会抛出异常<code v-pre>RuntimeError: Event loop is closed</code></td>
</tr>
<tr>
<td>loop.run_forever()</td>
<td>运行事件循环直到 stop() 被调用</td>
</tr>
<tr>
<td>loop.stop()</td>
<td>停止事件循环</td>
...
<tr>
<td>loop.is_running()</td>
<td>事件循环是否正在运行</td>
</tr>
<tr>
<td>loop.close()</td>
<td>关闭事件循环，当这个函数被调用的时候，循环必须处于非运行状态</td>
</tr>
<tr>
<td>loop.is_closed()</td>
<td>事件循环是否已经被关闭</td>
</tr>
<tr>
<td>loop.run_in_executor(executor, func, *args)</td>
<td>在指定的执行器中调用func,返回Future对象；执行器可以为：<br />（1）None,使用默认执行器，线程池<br />（2）concurrent.futures.ThreadPoolExecutor()对象，线程池<br />（3）concurrent.futures.ProcessPoolExecutor()对象，进程池<br />如果要给函数func传递字典参数，则可以使用标准库<code v-pre>functools.partial</code>来对函数进行一层包装</td>
</tr>
</tbody>
</table>
<h4 id="可等待对象" tabindex="-1"><a class="header-anchor" href="#可等待对象" aria-hidden="true">#</a> 可等待对象</h4>
<p>文档：<a href="https://docs.python.org/zh-cn/3.9/library/asyncio-task.html#awaitables" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.9/library/asyncio-task.html#awaitables<ExternalLinkIcon/></a></p>
<p>如果一个对象可以在 <a href="https://docs.python.org/zh-cn/3.9/reference/expressions.html#await" target="_blank" rel="noopener noreferrer"><code v-pre>await</code><ExternalLinkIcon/></a> 语句中使用，那么它就是 <strong>可等待</strong> 对象。许多 asyncio API 都被设计为接受可等待对象。</p>
<p>可等待对象有几下几种类型:</p>
<ul>
<li>协程</li>
<li>Task</li>
<li>Future</li>
<li>拥有<code v-pre>__await__</code>方法的对象</li>
</ul>
<h4 id="task对象" tabindex="-1"><a class="header-anchor" href="#task对象" aria-hidden="true">#</a> Task对象</h4>
<p>文档：<a href="https://docs.python.org/zh-cn/3.9/library/asyncio-task.html#task-object" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.9/library/asyncio-task.html#task-object<ExternalLinkIcon/></a></p>
<p>Task说明</p>
<ul>
<li>
<p>Task对象是对协程对象的一层包装，该协程会被<strong>自动调度执行</strong></p>
<p>Task创建完后会被<strong>自动调度执行</strong>，所以如果在事件循环运行之前创建Task，会报错<code v-pre>RuntimeError: no running event loop</code></p>
</li>
<li>
<p>Task对象是线程不安全的</p>
</li>
...
<p>创建Task实例的方法</p>
<ul>
<li>高级API ：<code v-pre>asyncio.create_task(协程对象, *, name=None)</code>（推荐使用）</li>
<li>低级API ：<code v-pre>loop.create_task(协程对象, *, name=None)</code></li>
<li>低级API：<code v-pre>asyncio.ensure_future(obj, *, loop=None)</code></li>
</ul>
<h4 id="future对象" tabindex="-1"><a class="header-anchor" href="#future对象" aria-hidden="true">#</a> Future对象</h4>
<p>文档：<a href="https://docs.python.org/zh-cn/3.9/library/asyncio-future.html#asyncio.Future" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.9/library/asyncio-future.html#asyncio.Future<ExternalLinkIcon/></a></p>
<p>Future说明</p>
<ul>
<li>Future表示异步操作的 <strong>最终结果</strong>，是一种特殊的<strong>低层级</strong> 可等待对象，通常情况下<strong>没有必要</strong>在应用层级的代码中创建 Future 对象</li>
<li>Future对象是线程不安全的</li>
</ul>
<p>Future简单示例</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8 -*-</span>
...
asyncio<span class="token punctuation">.</span>run<span class="token punctuation">(</span>main<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre></div><h4 id="对象检测" tabindex="-1"><a class="header-anchor" href="#对象检测" aria-hidden="true">#</a> 对象检测</h4>
<table>
<thead>
<tr>
<th>检测方法</th>
...
<tbody>
<tr>
<td>asyncio.iscoroutinefunction(协程函数)</td>
<td>返回是否是协程函数</td>
</tr>
<tr>
<td>asyncio.iscoroutine(协程对象)</td>
<td>返回是否是协程对象</td>
</tr>
<tr>
<td>asyncio.isfuture(future)</td>
<td>返回是否是Future对象</td>
</tr>
<tr>
<td>inspect.isawaitable(对象)</td>
<td>返回是否是可等待对象</td>
</tr>
</tbody>
</table>
<blockquote>
<p>协程函数、协程对象也可以使用<code v-pre>inspect.iscoroutinefunction(协程函数)</code>和<code v-pre>inspect.iscoroutine(协程对象)</code>来检测，</p>
<p>但是<code v-pre>inspect</code>只能检测使用<code v-pre>async def</code>定义的协程，对于使用基于生成器的协程，则无法检测</p>
</blockquote>
<h4 id="异步迭代器" tabindex="-1"><a class="header-anchor" href="#异步迭代器" aria-hidden="true">#</a> 异步迭代器</h4>
<p>文档：<a href="https://docs.python.org/zh-cn/3.9/reference/datamodel.html#asynchronous-iterators" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.9/reference/datamodel.html#asynchronous-iterators<ExternalLinkIcon/></a></p>
<p>异步迭代器可以在其 <code v-pre>__anext__</code> 方法中调用异步代码</p>
<p>异步迭代器可在 <a href="https://docs.python.org/zh-cn/3.9/reference/compound_stmts.html#async-for" target="_blank" rel="noopener noreferrer"><code v-pre>async for</code><ExternalLinkIcon/></a> 语句中使用</p>
<p>异步迭代器需要定义如下方法</p>
<p>（1）<code v-pre>def __aiter__(self)</code></p>
<p>必须返回一个可等待对象，一般返回自己</p>
<p>（2）<code v-pre>async def __anext__(self)</code></p>
<p>必须返回一个下一次迭代的结果值。 当迭代结束时应该引发 <a href="https://docs.python.org/zh-cn/3.9/library/exceptions.html#StopAsyncIteration" target="_blank" rel="noopener noreferrer"><code v-pre>StopAsyncIteration</code><ExternalLinkIcon/></a> 错误</p>
<p>代码示例</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8 -*-</span>
...
asyncio<span class="token punctuation">.</span>run<span class="token punctuation">(</span>main<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre></div><h4 id="异步上下文管理器" tabindex="-1"><a class="header-anchor" href="#异步上下文管理器" aria-hidden="true">#</a> 异步上下文管理器</h4>
<p>文档：<a href="https://docs.python.org/zh-cn/3.9/reference/datamodel.html#asynchronous-context-managers" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.9/reference/datamodel.html#asynchronous-context-managers<ExternalLinkIcon/></a></p>
<p>异步上下文管理器 是上下文管理器的一种，它能够在其 <code v-pre>__aenter__</code> 和 <code v-pre>__aexit__</code> 方法中暂停执行。</p>
<p>异步上下文管理器可在 <a href="https://docs.python.org/zh-cn/3.9/reference/compound_stmts.html#async-with" target="_blank" rel="noopener noreferrer"><code v-pre>async with</code><ExternalLinkIcon/></a> 语句中使用</p>
<p>异步上下文管理器需要实现如下方法</p>
<p>（1）<code v-pre>async def __aenter__(self)</code></p>
<p>返回值是<code v-pre>async with xx as xx</code>语句中as后面的对象，必须返回一个可等待对象</p>
<p>（2）<code v-pre>async def __aexit__(self, exc_type, exc_val, exc_tb)</code></p>
<p>当<code v-pre>with</code>语句执行结束时调用此函数，用于执行一些资源清理的操作</p>
<p>代码示例</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8 -*-</span>
...
asyncio<span class="token punctuation">.</span>run<span class="token punctuation">(</span>main<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre></div><h4 id="控制协程并发数量" tabindex="-1"><a class="header-anchor" href="#控制协程并发数量" aria-hidden="true">#</a> 控制协程并发数量</h4>
<p>可以自己手动控制也可以使用<code v-pre>asyncio.Semaphore(并发)</code>，两个代码都不难，但以下两种代码还是有些区别的，假设总请求数为10，并发为2，那么：</p>
<ul>
<li>
<p>手动控制的是等2个请求完全完成后再去请求后2个，<code v-pre>Semaphore</code>是2个请求中任意一个完成就会再启动一个新请求，</p>
<p><code v-pre>Semaphore</code>效率更高，手动控的制控制台信息更直观</p>
</li>
<li>
<p><code v-pre>Semaphore</code>代码量更小</p>
</li>
</ul>
<p>自己手动控制并发演示</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
...
<p>使用<code v-pre>asyncio.Semaphore</code>控制并发</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8 -*-</span>
...
<h4 id="协程局部变量" tabindex="-1"><a class="header-anchor" href="#协程局部变量" aria-hidden="true">#</a> 协程局部变量</h4>
<p>文档：<a href="https://docs.python.org/zh-cn/3.10/library/contextvars.html" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.10/library/contextvars.html<ExternalLinkIcon/></a></p>
<p><code v-pre>contextvars</code>与<code v-pre>threading.local</code>类似，用于异步中管理上下文</p>
<p>💡 提醒： <code v-pre>asyncio</code>并没有提供<code v-pre>local</code>类</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token number">2022</span>-04-07 <span class="token number">11</span>:45:22,185	 <span class="token punctuation">[</span>MainThread, <span class="token number">360196</span><span class="token punctuation">]</span> 测试1：协程并发修改全局变量
...
<h2 id="六、面向对象" tabindex="-1"><a class="header-anchor" href="#六、面向对象" aria-hidden="true">#</a> 六、面向对象</h2>
<h3 id="装饰器-2" tabindex="-1"><a class="header-anchor" href="#装饰器-2" aria-hidden="true">#</a> 装饰器</h3>
<p>（1）属性装饰器 <code v-pre>@property</code></p>
<ul>
<li>可以将一个方法可以当做属性来访问，访问时不需要加()</li>
<li>同时该属性不允许直接修改，如果需要修改和删除功能，需要编写<code v-pre>@函数名.setter</code>和<code v-pre>@函数名.deleter</code>装饰的同名函数</li>
<li>通过黑魔法【._类名__属性名】可以修改属性值，但是强烈不建议使用这种方法</li>
</ul>
<p>（2）类方法装饰器 <code v-pre>@classmethod</code></p>
<p>被修饰的函数第一个参数不再是实例对象而是 类对象</p>
<p>（3）静态方法装饰器 <code v-pre>@staticmethod</code></p>
<p>修饰的函数第一个参数可以不用传，装饰器会自动给我们传进去</p>
<p>代码示例</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<p>Python支持单继承和多继承</p>
<h4 id="哪些属性不会继承" tabindex="-1"><a class="header-anchor" href="#哪些属性不会继承" aria-hidden="true">#</a> 哪些属性不会继承</h4>
<p>父类中的<strong>私有属性</strong>在子类中不能直接访问，但可以通过**._父类__属性**来访问</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token punctuation">{</span><span class="token string">'_A__money'</span><span class="token builtin class-name">:</span> <span class="token number">1000</span>, <span class="token string">'_name'</span><span class="token builtin class-name">:</span> <span class="token string">'我叫大A'</span><span class="token punctuation">}</span>
<span class="token number">1000</span>
</code></pre></div><h4 id="类与类之间的属性查找顺序" tabindex="-1"><a class="header-anchor" href="#类与类之间的属性查找顺序" aria-hidden="true">#</a> 类与类之间的属性查找顺序</h4>
<p>按照【深度优先】的搜索顺序，使用的是C3算法</p>
<p>使用<code v-pre>类对象.__mro__</code> 或 <code v-pre>类对象.mro()方法</code> 可以显示查找顺序</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code>Class C.__init__ called
...
<span class="token punctuation">(</span><span class="token operator">&lt;</span>class <span class="token string">'__main__.C'</span><span class="token operator">></span>, <span class="token operator">&lt;</span>class <span class="token string">'__main__.A'</span><span class="token operator">></span>, <span class="token operator">&lt;</span>class <span class="token string">'__main__.B'</span><span class="token operator">></span>, <span class="token operator">&lt;</span>class <span class="token string">'object'</span><span class="token operator">></span><span class="token punctuation">)</span>
</code></pre></div><h4 id="super解决多继承下的问题" tabindex="-1"><a class="header-anchor" href="#super解决多继承下的问题" aria-hidden="true">#</a> super解决多继承下的问题</h4>
<p>若要调用父类方法，强烈建议使用<code v-pre>super()</code>而不是直接写父类名，因为在多继承中这会有问题</p>
<p>错误代码示例</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<h4 id="继承相关魔法方法" tabindex="-1"><a class="header-anchor" href="#继承相关魔法方法" aria-hidden="true">#</a> 继承相关魔法方法</h4>
<table>
<thead>
<tr>
<th>方法</th>
...
<tbody>
<tr>
<td><code v-pre>类对象.__base__</code></td>
<td>类对象的父类对象，多继承情况下也只显示一个（注意：实例对象没有这个属性）</td>
</tr>
<tr>
<td><code v-pre>类对象.__bases__</code></td>
<td>类对象的父类对象元祖，多继承情况下显示所有父类（注意：实例对象没有这个属性）</td>
</tr>
<tr>
<td><code v-pre>类对象.__subclasses__</code></td>
<td>类对象的子类对象列表，与<code v-pre>__bases__</code>相对应（注意：实例对象没有这个属性）</td>
</tr>
<tr>
<td><code v-pre>类对象.__mro__</code> 或 <code v-pre>类对象.mro()</code></td>
<td>类与类之间的属性查找顺序（前面已经讲过）（注意：实例对象没有这个属性）</td>
</tr>
<tr>
<td><code v-pre>实例对象.__class</code>__</td>
<td>实例所属的类对象（本章扩展内容，与继承没有关系，单纯是记录一下）</td>
</tr>
</tbody>
</table>
<h3 id="反射" tabindex="-1"><a class="header-anchor" href="#反射" aria-hidden="true">#</a> 反射</h3>
<p>反射就是通过<strong>字符串</strong>映射出对象的方法</p>
<p>具有反射能力的函数包括<code v-pre>type()</code>、<code v-pre>isinstance()</code>、<code v-pre>callable()</code>、<code v-pre>dir</code>、<code v-pre>getattr()</code>等</p>
<p>这里主要说一下<code v-pre>getattr</code>系列的几个函数</p>
<table>
<thead>
<tr>
<th>函数</th>
...
<td>获取object.name属性值，如果属性不存在且未设置<code v-pre>default</code>，则抛出<code v-pre>AttributeError</code>，name必须为字符串</td>
</tr>
<tr>
<td>setattr(object, name, value)</td>
<td>设置object.name属性值，如果存在则覆盖否则新增，name必须为字符串</td>
</tr>
<tr>
<td>hasattr(object, name)</td>
<td>判断是否有object.name属性，name必须为字符串</td>
</tr>
<tr>
<td>delattr(object, name)</td>
<td>删除object.name属性，如果属性不存在抛出<code v-pre>AttributeError</code>，name必须为字符串</td>
</tr>
</tbody>
</table>
<p>代码示例</p>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token punctuation">(</span><span class="token number">1</span>, <span class="token number">2</span><span class="token punctuation">)</span>
...
</code></pre></div><h3 id="魔法方法" tabindex="-1"><a class="header-anchor" href="#魔法方法" aria-hidden="true">#</a> 魔法方法</h3>
<table>
<thead>
<tr>
<th>分类</th>
...
<tr>
<td>self[key]</td>
<td><code v-pre>__getitem__</code>、<code v-pre>__setitem__</code>、<code v-pre>__delitem__</code></td>
<td>通过<code v-pre>self[key]</code>访问时调用</td>
</tr>
<tr>
<td>可视化</td>
<td><code v-pre>__repr__</code>、<code v-pre>__str__</code>、<code v-pre>__format__</code></td>
<td>可视化</td>
</tr>
<tr>
<td>可迭代对象和迭代器</td>
<td><code v-pre>__iter__</code>、<code v-pre>__next__</code></td>
<td>可迭代对象和迭代器</td>
</tr>
<tr>
<td>with上下文管理</td>
<td><code v-pre>__enter__</code>、<code v-pre>__exit__</code></td>
<td></td>
</tr>
<tr>
<td>实例属性查找</td>
...
<tr>
<td>描述器</td>
<td><code v-pre>__get__</code>、<code v-pre>__set__</code>、<code v-pre>__delete__</code></td>
<td></td>
</tr>
<tr>
<td>运算符重载</td>
<td><code v-pre>__lt__</code></td>
<td>小于，&lt;</td>
</tr>
<tr>
<td></td>
<td><code v-pre>__le__</code></td>
<td>小于等于，&lt;=</td>
</tr>
<tr>
<td></td>
...
<tr>
<td></td>
<td><code v-pre>__gt__</code></td>
<td>大于，&gt;</td>
</tr>
<tr>
<td></td>
<td><code v-pre>__ge__</code></td>
<td>大于等于，&gt;=</td>
</tr>
<tr>
<td></td>
<td><code v-pre>__ne__</code></td>
<td>不等于，!=</td>
</tr>
<tr>
<td></td>
...
<tr>
<td></td>
<td><code v-pre>__add__</code></td>
<td>加，+</td>
</tr>
<tr>
<td></td>
<td><code v-pre>__sub__</code></td>
<td>减，-</td>
</tr>
<tr>
<td></td>
<td>__<code v-pre>mul__</code></td>
<td>乘，*</td>
</tr>
<tr>
<td></td>
<td>__<code v-pre>truediv__</code></td>
<td>除，5 / 3 = 1.6666666666666667</td>
</tr>
<tr>
<td></td>
<td><code v-pre>__floordiv__</code></td>
<td>地板除，5 // 3 = 1</td>
</tr>
<tr>
<td></td>
<td><code v-pre>__mod__</code></td>
<td>取余，%</td>
</tr>
<tr>
<td></td>
<td><code v-pre>__pow__</code></td>
<td>计算次方， 2 ** 3 = 2 * 2 * 2 = 8</td>
</tr>
<tr>
<td></td>
<td><code v-pre>__divmod__</code></td>
<td>等同于 <code v-pre>(x//y, x%y)</code></td>
</tr>
<tr>
<td></td>
<td></td>
...
<tr>
<td></td>
<td><code v-pre>__iadd__</code></td>
<td>+=</td>
</tr>
<tr>
<td></td>
<td><code v-pre>__isub__</code></td>
<td>-=</td>
</tr>
<tr>
<td></td>
<td><code v-pre>__imul__</code></td>
<td>*=</td>
</tr>
<tr>
<td></td>
<td><code v-pre>__itruediv__</code></td>
<td>/=</td>
</tr>
<tr>
<td></td>
<td><code v-pre>__imod__</code></td>
<td>%=</td>
</tr>
<tr>
<td></td>
<td><code v-pre>__ifloordiv__</code></td>
<td>//=</td>
</tr>
<tr>
<td></td>
<td><code v-pre>__ipow__</code></td>
<td>**=</td>
</tr>
</tbody>
</table>
<h4 id="new" tabindex="-1"><a class="header-anchor" href="#new" aria-hidden="true">#</a> <code v-pre>__new__</code></h4>
<p>文档：<a href="https://docs.python.org/zh-cn/3.10/reference/datamodel.html#object.__new__" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.10/reference/datamodel.html#object.<strong>new</strong><ExternalLinkIcon/></a></p>
<p>创建类实例对象并返回，它可以让我们定制实例创建过程，比如实现<strong>单例模式</strong></p>
<p>默认的<code v-pre>__new__</code>行为</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
</code></pre></div><p>使用<code v-pre>__new__</code>实现线程安全的单例类</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<h4 id="del" tabindex="-1"><a class="header-anchor" href="#del" aria-hidden="true">#</a> <code v-pre>__del__</code></h4>
<p>文档：<a href="https://docs.python.org/zh-cn/3.10/reference/datamodel.html#object.__del__" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.10/reference/datamodel.html#object.<strong>del</strong><ExternalLinkIcon/></a></p>
<p>在实例将被销毁时调用，注意：<code v-pre>del x</code> 并不直接调用 <code v-pre>x.__del__()</code> --- 前者会将 <code v-pre>x</code> 的引用计数减一，而后者仅会在 <code v-pre>x</code> 的引用计数变为零时被调用。</p>
<p>代码示例</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<h4 id="dict" tabindex="-1"><a class="header-anchor" href="#dict" aria-hidden="true">#</a> <code v-pre>__dict__</code></h4>
<p>文档：<a href="https://docs.python.org/zh-cn/3.10/library/stdtypes.html#object.__dict__" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.10/library/stdtypes.html#object.<strong>dict</strong><ExternalLinkIcon/></a></p>
<p>这个太重要了，后面会经常用到，给一个简单的例子</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
</code></pre></div><h4 id="self-key" tabindex="-1"><a class="header-anchor" href="#self-key" aria-hidden="true">#</a> <code v-pre>self[key]</code></h4>
<p><a href="https://docs.python.org/zh-cn/3.10/reference/datamodel.html#object.__getitem__" target="_blank" rel="noopener noreferrer">文档：https://docs.python.org/zh-cn/3.10/reference/datamodel.html#object.<strong>getitem</strong><ExternalLinkIcon/></a></p>
<p>代码示例</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token number">100</span>
bob
...
</code></pre></div><h4 id="可视化" tabindex="-1"><a class="header-anchor" href="#可视化" aria-hidden="true">#</a> 可视化</h4>
<p>文档：<a href="https://docs.python.org/zh-cn/3.10/reference/datamodel.html#object.__repr__" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.10/reference/datamodel.html#object.<strong>repr</strong><ExternalLinkIcon/></a></p>
<ul>
<li>
<p><code v-pre>__str__</code>和<code v-pre>__repr__</code>作用类似，推荐两个定义成一样的，并且优先定义<code v-pre>__repr__</code>（<code v-pre>__str__</code>也可以不定义会自动调用<code v-pre>__repr__</code>）</p>
</li>
<li>
<p><code v-pre>__str__</code>和<code v-pre>__repr__</code>不同的例子可以参考<code v-pre>datetime</code>模块实现</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token keyword">from</span> datetime <span class="token keyword">import</span> date
...
<li>
<p><code v-pre>__format__</code>用的并不多，当需要一个对象可以展示多种样式时可以定义这个方法</p>
</li>
</ul>
<p>示例代码</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token operator">&lt;</span>__main__.Person object at 0x00000210C796590<span class="token operator"><span class="token file-descriptor important">8</span>></span>
...
</code></pre></div><h4 id="可迭代对象和迭代器" tabindex="-1"><a class="header-anchor" href="#可迭代对象和迭代器" aria-hidden="true">#</a> 可迭代对象和迭代器</h4>
<p>文档：<a href="https://docs.python.org/zh-cn/3.10/library/stdtypes.html#container.__iter__" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.10/library/stdtypes.html#container.<strong>iter</strong><ExternalLinkIcon/></a></p>
<hr />
<p><strong>（1）基础知识</strong></p>
<p>语法定义：实现了<code v-pre>__iter__</code>方法的对象称为可迭代对象，实现了<code v-pre>__iter__</code>方法和<code v-pre>__next__</code>的对象称为迭代器</p>
<p>包含关系：迭代器是可迭代对象，但是可迭代对象不一定是迭代器</p>
<br />
<p>相同点：都可以使用<code v-pre>for xx in xx</code>语句</p>
<p>不同点：</p>
<ul>
<li>
<p><strong>同一个迭代器对象</strong>只能使用<strong>一次</strong>for语句迭代</p>
</li>
<li>
<p><strong>同一个可迭代对象</strong>可以<strong>多次</strong>使用for语句迭代，原因在于<code v-pre>__iter__</code>必须要返回一个迭代器对象</p>
</li>
</ul>
<br />
<p>相关内建函数：</p>
<ul>
<li><code v-pre>iter(可迭代对象)</code> 将可迭代对象转为一个新的迭代器返回，等同于调用<code v-pre>可迭代对象.__iter__()</code></li>
<li><code v-pre>next(迭代器)</code>获取下一次迭代的值，迭代完成后会抛出<code v-pre>StopIteration</code>异常，for语句会自动帮我们捕获，然后退出循环</li>
</ul>
<br />
<p>数据类型举例</p>
<ul>
<li>迭代器：生成器</li>
<li>可迭代对象：字符串、列表、元组、字典等</li>
</ul>
<br />
<p><strong>（2）迭代次数不同示例</strong></p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment"># !/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code>------------------------- 一个可迭代对象和一个迭代器 -------------------------
...
<br />
<p><strong>（3）<code v-pre>__iter__</code>和<code v-pre>__next__</code>方法</strong></p>
<p><code v-pre>__iter__</code>必须返回一个迭代器，此时可以有以下几种返回值：</p>
<ul>
<li>返回实例本身(<code v-pre>self</code>)，意味着实例本身就是迭代器，所以也需要实现<code v-pre>__next__</code>方法</li>
<li>将可迭代对象转为迭代器并返回，<code v-pre>return iter(可迭代对象)</code></li>
<li>返回生成器（生成器是迭代器的一种）</li>
</ul>
<p><code v-pre>__next__</code>方法返回下一个值，如果值已经取完，抛出<code v-pre>StopIteration</code>，<code v-pre>for</code>语句会自动捕捉这个异常，然后退出循环</p>
<p>示例代码 - 仿<code v-pre>range</code></p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
True
True
</code></pre></div><p><strong>（4）迭代流程扩展</strong></p>
<p>一个完整的迭代流程如下：</p>
<p>① 检查对象是否实现了<code v-pre>__iter__</code>方法，如果实现了就调用它，获取一个迭代器</p>
<p>② 如果没有实现<code v-pre>__iter__</code>方法，<strong>但是实现了<code v-pre> __getitem__</code> 方法，Python会创建一个迭代器，尝试按顺序（从索引 0 开始）获取元素</strong></p>
<p>​     如果尝试失败，Python抛出 <code v-pre>TypeError</code>异常，通常会提示<code v-pre>&quot;x object is not iterable&quot;</code></p>
<p>不实现<code v-pre>__iter__</code>但是实现<code v-pre>__getitem__</code>示例</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token number">5</span>
...
False
False
</code></pre></div><h4 id="with上下文管理" tabindex="-1"><a class="header-anchor" href="#with上下文管理" aria-hidden="true">#</a> with上下文管理</h4>
<p>文档</p>
<p>（1）<a href="https://docs.python.org/zh-cn/3.10/reference/compound_stmts.html#the-with-statement" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.10/reference/compound_stmts.html#the-with-statement<ExternalLinkIcon/></a></p>
<p>（2）<a href="https://docs.python.org/zh-cn/3.10/reference/datamodel.html#object.__enter__" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.10/reference/datamodel.html#object.<strong>enter</strong><ExternalLinkIcon/></a></p>
<p><strong>说明</strong></p>
<p><code v-pre>__enter__</code>：</p>
<ul>
<li><strong>使用<code v-pre>with..as</code>语句时，<code v-pre>__enter__</code>的返回值就等于<code v-pre>as</code>后面跟的变量</strong></li>
<li>如果<code v-pre>__enter__</code>方法发生错误，那么意味着<code v-pre>with</code>语句尚未开始执行，<code v-pre>__exit__</code>自然也不会执行</li>
<li>如果<code v-pre>__enter__</code>方法未发生错误，那么<code v-pre>__exit__()</code> 将总是被调用</li>
</ul>
<p><code v-pre>__exit__</code>:</p>
<ul>
<li><code v-pre>with</code>语句执行完成后，会自动执行<code v-pre>__exit__</code>方法，即使在with上下文中遇到异常，<code v-pre>__exit__</code>也会被执行</li>
<li><strong><code v-pre>__exit__</code>的返回值决定<code v-pre>with</code>语句中的异常是否向外抛出（等效于<code v-pre>False</code>为抛出异常，等效于<code v-pre>True</code>为压制异常）</strong></li>
</ul>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code>__enter__ called
...
__exit__ called
</code></pre></div><p><strong>异常抛出与压制</strong></p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<h4 id="实例属性查找" tabindex="-1"><a class="header-anchor" href="#实例属性查找" aria-hidden="true">#</a> 实例属性查找</h4>
<p>文档：<a href="https://docs.python.org/zh-cn/3.10/reference/datamodel.html#object.__getattribute__" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.10/reference/datamodel.html#object.<strong>getattribute</strong><ExternalLinkIcon/></a></p>
<p><strong>实例属性查找顺序如下</strong></p>
<p>（1）主要顺序</p>
<p>① 调用<code v-pre>__getattribute__(item)</code> --&gt; 返回（计算后的）正常值</p>
<p>② 调用<code v-pre>__getattribute__(item)</code> --&gt; 返回（计算后的）异常值<code v-pre>AttributeError</code> --&gt; 如果定义了<code v-pre>__getattr__</code>则调用，否则继续抛出原来的<code v-pre>AttributeError</code></p>
<blockquote>
<p>我们可以称<code v-pre>__getattribute__</code>为属性拦截器</p>
</blockquote>
<br />
<p>（2）计算后的值如何获得？
实例字典 --&gt; 类字典 --&gt; ... --&gt; 直到<code v-pre>object</code>类字典 --&gt; <code v-pre>object</code>抛出<code v-pre>AttributeError</code></p>
<br />
<p>（3）注意事项</p>
<p>① <code v-pre>__getattribute__(item)</code>方法中不能再使用<code v-pre>self.x</code>、<code v-pre>self.__dict__</code>等属性，因为这会造成无限递归</p>
<p>② <code v-pre>__getattr__</code>中不能再使用<code v-pre>self.不存在的属性</code>，因为这同样会造成无限递归</p>
<p>③ <code v-pre>object</code>对象没有<code v-pre>__getattr__</code>方法，所以我们不能调用父类或object的<code v-pre>__getattr__</code>方法</p>
<br />
<p><strong>实例属性查找-正常值示例</strong></p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<p><strong>实例属性查找-AttributeError示例</strong></p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code>Called __getattribute__<span class="token punctuation">(</span>abc<span class="token punctuation">)</span>
Called __getattribute__<span class="token punctuation">(</span>__class__<span class="token punctuation">)</span>
实例对象Person不存在abc属性
</code></pre></div><h4 id="描述器" tabindex="-1"><a class="header-anchor" href="#描述器" aria-hidden="true">#</a> 描述器</h4>
<h5 id="描述器定义" tabindex="-1"><a class="header-anchor" href="#描述器定义" aria-hidden="true">#</a> 描述器定义</h5>
<p>如果实现了<code v-pre>__get__</code>、<code v-pre>__set__</code> 、<code v-pre>__delete__</code>中的任何一个，就实现了描述器定义</p>
<p>如果只实现了<code v-pre>__get__</code>，那么就是非数据描述器；</p>
<p>如果实现了<code v-pre>__get__</code>和<code v-pre>__set__</code> 或 <code v-pre>__get__</code>和<code v-pre>__delete__</code> ，那么就是数据描述器</p>
<h5 id="非数据描述器示例" tabindex="-1"><a class="header-anchor" href="#非数据描述器示例" aria-hidden="true">#</a> 非数据描述器示例</h5>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code>Class A<span class="token punctuation">(</span><span class="token punctuation">)</span>.__init__ called
...
</code></pre></div><h5 id="非数据描述器应用" tabindex="-1"><a class="header-anchor" href="#非数据描述器应用" aria-hidden="true">#</a> 非数据描述器应用</h5>
<p>实现<code v-pre>@classmethod</code>、<code v-pre>@staticmethod</code>、<code v-pre>@property</code>装饰器</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code>class method
static method
pongclass method
static method
</code></pre></div><h4 id="运算符重载" tabindex="-1"><a class="header-anchor" href="#运算符重载" aria-hidden="true">#</a> 运算符重载</h4>
<p>文档：<a href="https://docs.python.org/zh-cn/3.10/reference/datamodel.html#emulating-numeric-types" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.10/reference/datamodel.html#emulating-numeric-types<ExternalLinkIcon/></a></p>
<p>示例</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code>True
...
</code></pre></div><p><strong>pathlib中的运算符重载</strong></p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<span class="token comment"># C:\Windows\System32\drivers\etc\hosts</span>
<span class="token comment"># True</span>
</code></pre></div><h3 id="元类" tabindex="-1"><a class="header-anchor" href="#元类" aria-hidden="true">#</a> 元类</h3>
<p><strong>文档</strong></p>
<p>（1）<a href="https://docs.python.org/zh-cn/3.10/library/functions.html#type" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.10/library/functions.html#type<ExternalLinkIcon/></a></p>
<p>（2）<a href="https://docs.python.org/zh-cn/3.10/reference/datamodel.html#metaclasses" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.10/reference/datamodel.html#metaclasses<ExternalLinkIcon/></a></p>
<p>元类就是创建类的类，type除了可以查看对象类型，还是内置的元类</p>
<p><strong>使用内置元类type创建类</strong></p>
<p>示例代码</p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token operator">&lt;</span>class <span class="token string">'__main__.A'</span><span class="token operator">></span>
...
</code></pre></div><p><strong>自定义元类</strong></p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<p>输出结果</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code>Metaclass<span class="token punctuation">.</span>__new__ called
...
</code></pre></div><p><strong>使用元类创建单例类</strong></p>
<details class="custom-container details"><summary>点击查看完整代码</summary>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
...
<p>输出结果</p>
<div class="language-bash ext-sh"><pre v-pre class="language-bash"><code><span class="token operator">&lt;</span>__main__.Single object at 0x000001D92436EE4<span class="token operator"><span class="token file-descriptor important">8</span>></span>
...
<span class="token operator">&lt;</span>__main__.Single object at 0x000001D92436EE4<span class="token operator"><span class="token file-descriptor important">8</span>></span>
<span class="token operator">&lt;</span>__main__.Single object at 0x000001D92436EE4<span class="token operator"><span class="token file-descriptor important">8</span>></span>
</code></pre></div><h3 id="抽象类" tabindex="-1"><a class="header-anchor" href="#抽象类" aria-hidden="true">#</a> 抽象类</h3>
<p>抽象类就是提取一对类的共同特征，抽象称一个类</p>
<p>抽象类不能单独实例化、执行，必须由其他类继承</p>
<p>所有类都要继承自抽象类，抽象类提供的方法必须实现，否则会报错</p>
<p>示例代码</p>
<div class="language-python ext-py"><pre v-pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
<span class="token comment"># -*- coding:utf-8-*-</span>
