...
**1、`set -o nounset (简写set -u)`变量不存在则报错退出脚本**
...
**2、`set -o errexit (简写set -e)` 脚本一旦报错便退出**
...
# 备注：还有一种方法也能达到同样的效果：bash -euxo pipefail demo.sh
```
...
::: details （7）配合xargs使用，搜索大文件并按照文件大小排序
...
```bash
[root@ap-hongkang ~]# seq 10 | sed -n 'h;$!{n;G};p'
2                                                                                                                               
1                                                                                                                               
4                                                                                                                               
3                                                                                                                               
