...
exports.prepareClientConfigFile = void 0;
const getComponentsFromDir_1 = require("./getComponentsFromDir");
const prepareClientConfigFile = async (app, options, identifier) => {
    // get components from directory
    const componentsFromDir = await (0, getComponentsFromDir_1.getComponentsFromDir)(options);
...
exports.prepareClientConfigFile = prepareClientConfigFile;
